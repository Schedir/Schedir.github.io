import { Color } from 'popmotion/node_modules/style-value-types/lib/types';
declare function test(v: any): boolean;
declare function parse(v: string | number): (number | import("popmotion/node_modules/style-value-types/lib/types").RGBA | import("popmotion/node_modules/style-value-types/lib/types").HSLA)[];
