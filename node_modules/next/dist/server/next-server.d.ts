...
import BaseServer, { Options, FindComponentsResult, RoutingItem } from 'next/dist/server/base-server';
...
export default class NextNodeServer extends BaseServer {
    ...
    protected ensureEdgeFunction(_pathname: string): Promise<void>;
    /**
