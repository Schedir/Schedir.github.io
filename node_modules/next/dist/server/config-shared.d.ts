...
import { ImageConfig, ImageConfigComplete, RemotePattern } from 'next/dist/shared/lib/image-config';
export declare type ServerRuntime = 'nodejs' | 'experimental-edge' | undefined;
