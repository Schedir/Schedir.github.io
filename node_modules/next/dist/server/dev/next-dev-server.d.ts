...
import type { RoutingItem } from 'next/dist/server/base-server';
...
export default class DevServer extends Server {
    ...
    protected ensureMiddleware(): Promise<any>;
    protected ensureEdgeFunction(pathname: string): Promise<any>;
    generateRoutes(): {
