    ...
    <motion.div>
      ...
      <div className='sticky top-[-44vh] z-[99] '>
        <div className='flex h-screen justify-center items-center '>
          ...
          >
            <svg className='overflow-clip scale-150 mb-[15vh] lg:mb-0 lg:scale-50 lg:mt-[30vh]' viewBox="0 0 4125 4151" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <img className='absolute' src='/HomeMedia/posidonia_bianca.png'/>
            {/* <motion.h1 
            id='stroke'
            style={{scale:1.5}} 
            className='
