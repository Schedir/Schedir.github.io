    ...
    <motion.div>
      ...
      <div className='sticky top-[-44vh] left-[20vw] z-[99] '>
        <div className='flex h-screen justify-center items-center mx-[20vw]'>
          <motion.div className='h-screen items-center' 
          style={{
          ...
          {/* <div className='absolute left-[calc(50vw-150px)] top-[54.2vh] '> */}
            <svg className='overflow-clip scale-90 lg:scale-125' viewBox="0 0 4125 4151" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            style={{scale:1.5}} 
            className='
            text-center text-transparent text-[40px] md:text-[55px] lg:text-[155px] 
            mt-[-27.5vh] z-30
            font-extrabold 
            bg-clip-text background-animate
            bg-gradient-to-r from-schedir-white via-white to-schedir-white'>posidonia</motion.h1>
