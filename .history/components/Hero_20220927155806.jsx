...
const Hero = ({heading, message}) => {
  return (
    <div className='flex items-center justify-center min-h-screen mb-0 bg-cover'>
        {/* Overlay */}
        <div className='absolute top-0 left-0 right-0 bottom-0 min-h-screen bg-black/20 z-[10]'/>
        <div className='absolute top-100 left-0 right-0 bottom-[-19px] h-[5rem] bg-gradient-to-b from-transparent to-schedir-blue z-[3]'/>
