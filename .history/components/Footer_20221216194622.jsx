...
const Footer = () => {
  return (
      <div className='relative bottom-0 z-[999]'>
        ...
        <footer className="p-4 bg-schedir-blue rounded-lg shadow md:px-16 md:py-8 z-[-11]">
            <div className="sm:flex sm:items-center sm:justify-between">
                <a className="flex items-center mb-4 sm:mb-0">
                    <img src="/HomeMedia/logoalghe0.png" className="mr-3 h-8" alt="Schedir Logo" />
                </a>
            ...
            <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">Posidonia™</a>. All Rights Reserved.
            </span>
        </footer>
