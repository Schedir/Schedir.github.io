        ...
        <div id='Navbar' style={{backgroundColor: `${color}`}} className='fixed left-0 top-0 w-screen ease-in duration-300 '>
            <div className='max-w-[1500px] h-28 m-auto flex justify-between items-center p-4'>
                ...
                <div className=" flex-row md:w-auto " id="navbar-default">
                    <ul className="flex flex-row p-3 mt-auto mr-auto bg-schedir-lavander/10 rounded-lg border-0 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-schedir-lavander/50 lg:mr-">
