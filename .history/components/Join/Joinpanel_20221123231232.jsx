                    ...
                    <motion.div 
                        ...
                        <div className='mx-10 my-10 grid md:grid-cols-2 gap-6'>
                            ...
                            <div className='col-span-1'>
                                <label htmlFor="email" class="block mb-2 text-sm font-medium text-schedir-g2">Full Name</label>
                                <input type="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-transparent focus:border-transparent block w-full p-2.5"
                                placeholder="name and surname" required/>
                            </div>
                            <div className='col-span-1'>
                                <label htmlFor="email" class="block mb-2 text-sm font-medium text-schedir-g2">Your email</label>
                                <input type="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-transparent focus:border-transparent block w-full p-2.5" placeholder="name@domain.com" required/>
                            </div>
                            ...
                            <div className='mt-2'>
                                <label htmlFor="underline_select" class="sr-only">Underline select</label>
