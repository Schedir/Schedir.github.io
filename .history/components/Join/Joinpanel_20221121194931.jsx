        ...
        <div className='w-[90vw] h-[75vh] bg-white bg-opacity-20 backdrop-blur-lg rounded-lg drop-shadow-lg'>
            ...
            <div className='mx-10 my-10'>
                ...
                <div className='flex justify-end'>
                    <div  class="overflow-hidden relative w-10 h-10 mr-3 bg-gray-100 rounded-full dark:bg-gray-600">
                        <svg data-popover-target="popover-user-profile" class="absolute -left-1 w-12 h-12 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
                    </div>
                ...
                <div className='flex justify-center my-5'>
                    <h1 className='lg:text-2xl mb-12 text-bold'>Travel with Schedir</h1>
                </div>
