    ...
    <div className='h-[100vh] flex justify-center items-center my-auto'>
            ...
            <motion.ul 
                ...
                className='h-full flex justify-center items-center'>
                    ...
                    <motion.div 
                        variants={boxAnimate}
                        className='container w-[90vw] h-[72vh] bg-white bg-opacity-20 backdrop-blur-lg rounded-lg drop-shadow-lg'>
                        ...
                        <div className='mx-10 my-10 grid md:grid-cols-2 gap-6'>
                            ...
                            <div className='absolute flex justify-center my-5 col-span-2'>
