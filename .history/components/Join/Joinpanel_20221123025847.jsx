                    ...
                    <motion.div 
                        ...
                        <div className='mx-10 my-10 grid md:grid-cols-2 gap-6'>
                            ...
                            <div className='col-span-1'>
                                ...
                                <input type="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-schedir-blue focus:border-schedir-blue block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
