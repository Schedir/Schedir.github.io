                    ...
                    <motion.div 
                        ...
                        <div className='mx-10 my-10 grid md:grid-cols-2 gap-6'>
                            ...
                            <div className='flex justify-center items-center'>
                                <button type="submit" className="text-schedir-blue bg-schedir-g2 hover:bg-blue-800 font-medium rounded-lg
                                text-sm w-[20vw] h-[5vh] sm:w-auto px-10 py-2.5 lg: lg:text-lg text-center">Submit</button>
                            </div>
