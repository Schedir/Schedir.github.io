    ...
    <div className='h-[100vh] flex justify-center items-center my-auto'>
            ...
            <motion.ul 
                ...
                className='h-full flex justify-center items-center'>
                    ...
                    <motion.div 
                        variants={boxAnimate}
                        className='container h-[72vh] bg-white bg-opacity-20 backdrop-blur-lg rounded-lg drop-shadow-lg'>

                        <div className='mx-10 my-10 grid md:grid-cols-2 gap-6'>

                            <div className='absolute flex right-10'>
                                <div data-popover-target="popover-user-profile" className="overflow-hidden relative w-10 h-10 mr-3 bg-gray-100 rounded-full dark:bg-gray-600">
                                ...
                                <div data-popover id="popover-user-profile" role="tooltip" className="absolute z-10 invisible inline-block w-64 text-sm font-light text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 dark:text-gray-400 dark:bg-gray-800 dark:border-gray-600">
                                    <div className="p-3">
                                        <div className="flex items-center justify-between mb-2">
                                            <a href="#">
                                                <img className="w-10 h-10 rounded-full" src="/HomeMedia/IMG_3.png" alt="Jese Leos"/>
                                            </a>
                                            <div>
                                ...
                                <div data-popover-target="popover-user-profile2"  className="overflow-hidden relative w-10 h-10 mr-3 bg-gray-100 rounded-full dark:bg-gray-600">
                                    <svg className="absolute -left-1 w-12 h-12 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd"></path></svg>
                                </div>

                                <div data-popover id="popover-user-profile2" role="tooltip" className="absolute z-10 invisible inline-block w-64 text-sm font-light text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 dark:text-gray-400 dark:bg-gray-800 dark:border-gray-600">
                                    <div className="p-3">
                                        <div className="flex items-center justify-between mb-2">
                                            <a href="#">
                                                <img className="w-10 h-10 rounded-full" src="/HomeMedia/IMG_2.png" alt="Jese Leos"/>
                                            </a>
                                            <div>
                                                <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs px-3 py-1.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Follow</button>
                                            </div>
                            ...
                            <div className='col-span-1'>
                                <label htmlFor="email" className="block mb-2 text-sm font-medium text-schedir-g2">Full Name</label>
                            ...
                            <div className='col-span-1'>
                                <label htmlFor="email" className="block mb-2 text-sm font-medium text-schedir-g2">Your email</label>
                            ...
                            <div className='col-span-1'>
                                <label htmlFor="countries" defaultValue={'DEFAULT'} className="block mb-2 text-sm font-medium text-schedir-g2">Purpose of the request</label>
                                <select id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-transparent focus:border-transparent block w-full p-2.5" >
                                <option value="DEFAULT" disabled selected>Choose a purpose</option>
                                <option value="1">Student</option>
                                <option value="2">Research</option>
                                <option value="3">Exploring</option>
                                <option value="4">Finding Nemo</option>
                                </select>           
                            </div>

                            <div className='col-span-1'>
                                <label htmlFor="countries" defaultValue={'DEFAULT'} className="block mb-2 text-sm font-medium text-schedir-g2">Country of origin</label>
                                <select id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-transparent focus:border-transparent block w-full p-2.5 ">
                                <option value="DEFAULT" disabled selected>Choose a continent</option>
                            ...
                            <div className='mt-2'>
                                <label htmlFor="underline_select" className="sr-only">Underline select</label>
                                    <select id="underline_select" defaultValue={'DEFAULT'} className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-200 appearance-none text-schedir-g2  focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                                        <option value="DEFAULT" disabled selected>Number of people</option>
                            ...
                            <div className='mt-1 col-span-2'>
                                <label htmlFor="message" className="block mb-2 text-sm font-medium text-schedir-g2">Your message</label>
                                <textarea id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg  focus:ring-transparent focus:border-transparent" placeholder="Share your story with us..."></textarea>
                            </div>
                            ...
                            <div className='mt-2 ml-4'>
                                <fieldset className='flex'>
                                    ...
                                    <div className="flex items-center mb-4 mr-12">
                                        <input required id="checkbox-1" type="checkbox" value="" className="w-4 h-4 text-schedir-g2 bg-gray-100 rounded " />
                                        <label htmlFor="checkbox-1" className="ml-2 text-sm font-medium text-schedir-white dark:text-gray-300">I agree to the <a href="#" className="text-schedir-g2 hover:underline ">terms and conditions</a>.</label>
                                    </div>

                                    <div className="flex items-center mb-4">
                                        <input id="checkbox-2" type="checkbox" value="" className="w-4 h-4 text-schedir-g2 bg-gray-100 rounded "/>
                                        <label htmlFor="checkbox-3" className="ml-2 text-sm font-medium text-schedir-white dark:text-gray-300">I am 18 years or older</label>
                                    </div>
                                </fieldset>
                            </div>

                            <div className='flex col-span-2 justify-center items-center'>
                                <button type="submit" className="text-schedir-blue bg-schedir-g2/90 hover:bg-schedir-g2 font-medium rounded-lg
             ...
             <div className='mx-10 my-10 grid md:grid-cols-2 gap-6'>
                ...
                <div className='mt-2'>
                    <label for="underline_select" className="sr-only">Underline select</label>
                        <select id="underline_select" className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-200 appearance-none text-black  focus:outline-none focus:ring-0 focus:border-gray-200 peer">
