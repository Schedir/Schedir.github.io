                            ...
                            <div className='mt-5 ml-4'>
                                <fieldset className='flex'>
                                    ...
                                    <div className="flex items-center mb-4 mr-12">
                                        ...
                                        <label for="checkbox-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree to the <a href="#" className="text-schedir-g2 hover:underline dark:text-blue-500">terms and conditions</a>.</label>
                                    </div>
