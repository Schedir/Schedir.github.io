                ...
                className='h-full flex justify-center items-center'>
                    ...
                    <motion.div 
                        ...
                        <div className='mx-10 my-10 grid md:grid-cols-2 gap-6'>
                            ...
                            <div className='col-span-1'>
                                <label htmlFor="countries" value={'DEFAULT'} className="block mb-2 text-sm font-medium text-schedir-g2">Purpose of the request</label>
                            ...
                            <div className='col-span-1'>
                                <label htmlFor="countries" value={'DEFAULT'} className="block mb-2 text-sm font-medium text-schedir-g2">Country of origin</label>
                                <select id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-transparent focus:border-transparent block w-full p-2.5 ">
                            ...
                            <div className='mt-2'>
                                <label htmlFor="underline_select" className="sr-only">Underline select</label>
                                    <select id="underline_select" value={'DEFAULT'} className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-200 appearance-none text-schedir-g2  focus:outline-none focus:ring-0 focus:border-gray-200 peer">
