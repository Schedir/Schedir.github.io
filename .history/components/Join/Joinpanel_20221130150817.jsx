    ...
    <div className='h-[100vh] flex justify-center items-center my-auto'>
            ...
            <motion.ul 
                ...
                className='h-full flex justify-center items-center'>
                    ...
                    bg-gradient-to-r from-schedir-g1 via-schedir-gneon to-schedir-gviolet'>
                    ...
                    <motion.div 
                        ...
                        <div className='mx-10 my-10 grid md:grid-cols-2 gap-6'>
                            ...
                            <div className='flex justify-center my-5 col-span-2'>
                                <h1 className='lg:text-2xl mb-2 text-bold text-schedir-gneon'>Travel with Schedir</h1>
                            </div>

                            <div className='col-span-1'>
                                <label htmlFor="email" className="block mb-2 text-sm font-medium text-schedir-gneon">Full Name</label>
                            ...
                            <div className='col-span-1'>
                                <label htmlFor="email" className="block mb-2 text-sm font-medium text-schedir-gneon">Your email</label>
                            ...
                            <div className='col-span-1'>
                                <label htmlFor="countries" className="block mb-2 text-sm font-medium text-schedir-gneon">Purpose of the request</label>
                            ...
                            <div className='col-span-1'>
                                <label htmlFor="countries" className="block mb-2 text-sm font-medium text-schedir-gneon">Country of origin</label>
                                <select id="countries" defaultValue={'DEFAULT'} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-transparent focus:border-transparent block w-full p-2.5 ">
                            ...
                            <div className='mt-2'>
                                <label htmlFor="underline_select" className="sr-only">Underline select</label>
                                    <select id="underline_select" defaultValue={'DEFAULT'} className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-200 appearance-none text-schedir-gneon  focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                            ...
                            <div className='mt-1 col-span-2'>
                                <label htmlFor="message" className="block mb-2 text-sm font-medium text-schedir-gneon">Your message</label>
                            ...
                            <div className='mt-2 ml-4'>
                                <fieldset className='flex'>
                                    ...
                                    <div className="flex items-center mb-4 mr-12">
                                        <input required id="checkbox-1" type="checkbox" value="" className="w-4 h-4 text-schedir-gneon bg-gray-100 rounded " />
                                        <label htmlFor="checkbox-1" className="ml-2 text-sm font-medium text-schedir-white dark:text-gray-300">I agree to the <a href="#" className="text-schedir-gneon hover:underline ">terms and conditions</a>.</label>
                                    </div>

                                    <div className="flex items-center mb-4">
                                        <input id="checkbox-2" type="checkbox" value="" className="w-4 h-4 text-schedir-gneon bg-gray-100 rounded "/>
                            ...
                            <div className='flex col-span-2 justify-center items-center'>
                                <button type="submit" className="text-schedir-blue bg-schedir-gneon/90 hover:bg-schedir-gneon font-medium rounded-lg
