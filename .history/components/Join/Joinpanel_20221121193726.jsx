        ...
        <div className='w-[90vw] h-[75vh] bg-white bg-opacity-20 backdrop-blur-lg rounded-lg drop-shadow-lg'>
            ...
            <div className='mx-10 my-10'>
                ...
                <div className='flex justify-center my-5'>
                    <h1 className='lg:text-2xl mb-12'>Travel with Schedir</h1>
                </div>
                ...
                <div className='my-5'>
                    <label for="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Purpo</label>
