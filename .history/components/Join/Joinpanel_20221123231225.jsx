                            ...
                            <div className='mt-2 ml-4'>
                                <fieldset className='flex'>
                                    ...
                                    <div className="flex items-center mb-4 mr-12">
                                        ...
                                        <label for="checkbox-1" className="ml-2 text-sm font-medium text-schedir-white dark:text-gray-300">I agree to the <a href="#" className="text-schedir-g2 hover:underline ">terms and conditions</a>.</label>
                                    </div>
