                        ...
                        <div className='mx-10 my-10 grid md:grid-cols-2 gap-6'>
                            ...
                            <div className='mt-2'>
                                <label for="underline_select" class="sr-only">Underline select</label>
                                    <select id="underline_select" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-200 appearance-nonetext-schedir-g2  focus:outline-none focus:ring-0 focus:border-gray-200 peer">
