                    ...
                    <motion.div 
                        ...
                        <div className='mx-10 my-10 grid md:grid-cols-2 gap-6'>
                            ...
                            <div className='mt-1 col-span-2'>
                                ...
                                <textarea id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg  focus:ring-schedir-g2 " placeholder="Leave a comment..."></textarea>
                            </div>
