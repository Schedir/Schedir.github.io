        ...
        <div className='max-w-[1500px] m-auto flex justify-between items-center p-4'>
            ...
            <div class="hidden w-full md:block md:w-auto " id="navbar-default">
                <ul class="flex flex-col p-3 mt-auto bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-gray-700/20">
                    ...
                    <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-[16px] text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border- md:p-0 ">The Route</a>
                    </li>
                    <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-[16px] text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border- md:p-0 ">The Schedir</a>
                    </li>
                    <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-[16px] text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border- md:p-0 ">Join the crew</a>
                    </li>
                </ul>
            </div>
