...
import { motion, useAnimation, useScroll, useTransform, useState, useEffect} from "framer-motion";
...
const Main = () => {
  ...
  const FadefromLeft = batch(Fade(), Move(1400,700, -2000, undefined), Sticky(undefined,30));
    ...
    <>
      <ScrollContainer>
        ...
        <ScrollPage>     
          ...
          <h2 className='leading-none text-2xl sm:text-[60px] text-gray-300 bold text-center'>
          ...
          {/* <Waves/>  */}
          <h2 className='text-1xl sm:text-[20px] text-gray-400 text-center '>
        ...
        <ScrollPage>
          <h2 className='leading-none    text-2xl sm:text-[70px] text-gray-300 bold text-center'>
            <Animator animation={batch(Fade(), Move(-500,200, 2000, undefined), Sticky(undefined,70))}>
            The breath of Balance
            </Animator>          
          </h2>     
          <h2 className='font-sans text-1xl sm:text-[20px] text-gray-400 text-center'>
            <Animator animation={batch(Fade(0,1), Move(undefined,300,undefined,-300), Sticky(undefined,40))}>
...
Breathe the wind deeply,<br/> listen to its voice and you will see your story. <br/>
        ...
        <ScrollPage>
          <h2 className='leading-none font-sans text-2xl sm:text-[70px] text-gray-300 bold text-center'>
        ...
        <ScrollPage>
          ...
          <h2 className='font-sans text-1xl sm:text-[20px] text-gray-400 text-center mb-0'>
