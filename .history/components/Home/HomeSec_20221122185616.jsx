            ...
            <defs>
                ...
                <linearGradient id="second" x1="50%" y1="0%" x2="50%" y2="100%">
                  ...
                  <stop offset="100%" stop-color="lightblue" stopOpacity="1">
                    <animate attributeName="stop-color" values="lightblue;orange;p dur="8s" repeatCount="indefinite" begin='0s'/>
                  </stop>
                </linearGradient>
                ...
                <linearGradient id="seventh" x1="50%" y1="0%" x2="50%" y2="100%">
                  ...
                  <stop offset="100%" stop-color="lightblue" stopOpacity="1">
                    <animate attributeName="stop-color" values="lightblue;orange;p dur="8s" repeatCount="indefinite" begin='2s'/>
                  </stop>
                </linearGradient>
              </defs>
          </svg>
