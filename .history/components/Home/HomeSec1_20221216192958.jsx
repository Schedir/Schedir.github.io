...
const HomeSec1 = () => {
  ...
  return (
    <div>
      <div className='flex justify-center items-center bg-opacity-50 lg:mt-[35vh]'>
        <div className='bg-fixed bg-[url("/HomeMedia/IMG_0121.jpg")] bg-cover w-screen h-[50vh] z-30 mx-0' >
          <p className='font-bold text-[19px] sm:text-[15px] md:text-[20px] lg:text-[38px] text-white mx-[10vw] lg:my-[5%] text-center
      ...
      <div className='relative bg-schedir-blue mb-[-25vh] mt-[-10vh] -z-30'>
        <div className="items-center justify-center my-auto mx-auto">
          ...
          <div className='scroll h-[300vh] justify-center'>
            ...
            <video id='vid'  preload="metadata" muted autoPlay playsInline loop src="/HomeMedia/Seq3.mp4" className='sticky top-[8vh] pt-[60vh]'>
              {/* <source src="/HomeMedia/Seq3.mp4" type="video/mp4"/>   */}
            </video>
            <script>
