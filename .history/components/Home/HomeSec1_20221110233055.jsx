    ...
    <div>
      <div className='relative bg-schedir-blue mb-[-25vh] mt-[-10vh] -z-10'>
        <div className="items-center justify-center my-auto mx-auto">
          ...
          <motion.img style={{y}} src='/HomeMedia/sfondoblu.png' className='pb-[20vh] z-10 absolute scale-105'/>
          <motion.img style={{y}} src='/HomeMedia/sfondorbg.png' className='pb-[20vh] -z-10 scale-105'/>
