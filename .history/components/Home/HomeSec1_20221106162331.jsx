  ...
  return (
    <AnimatePresence>
        ...
        <div className="items-center justify-center my-auto mx-auto">
                ...
                <div
                className='sticky top-[35vh] text-left text-[25px] sm:text-[40px] md:text-[55px] lg:text-[70px] font-bold text-schedir-blue z-[30] mx-[10vw] bg-schedir-blue'>
                ...
                <motion.img style={{y}} src='/media/sfondosfumatura5.png'/>
