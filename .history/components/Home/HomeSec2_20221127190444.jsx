  ...
  return (
    <>
        ...
        <div ref={ref} className='z-20 mt-[0vh] mb-[60vh] '>
              <div className='flex justify-end text-right z-30 mb-[10vh] mx-[7%] ml-[50vw]'>
                <motion.div  
                  ...
                  style={{opacity:useTransform(scrollYProgress, 
                    ...
                    //   [0, .5, 1],
                    //   [0 + '%', -100 + '%', 0 + '%'])}}
                    className='text-transparent bg-clip-text background-animate bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell text-[25px] sm:text-[40px] md:text-[55px] lg:text-[90px] font-bold '>
                    ...
                    className='text-transparent bg-clip-text background-animate bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell text-[15px] sm:text-[15px] md:text-[20px] lg:text-[29px]'>
