  ...
  return (
    <AnimatePresence>
      ...
      <div className='relative bg-schedir-blue'>
        ...
        <motion.div className='flex justify-end mx-[5vw]'>
                <button type="button" 
                        className=" sticky bott
                        background-animate bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell 
