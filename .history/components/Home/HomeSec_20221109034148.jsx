      ...
      <div className='relative bg-schedir-blue z-10 '>
        ...
        <div className='flex h-screen justify-center items-center mx-[10vw]'>
          ...
          <motion.svg 
            initial={"hidden"}
            whileInView={"visible"}
            width="7293" height="1418" viewBox="0 0 7293 1418" fill="background-animate
            bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell " xmlns="http://www.w3.org/2000/svg">
