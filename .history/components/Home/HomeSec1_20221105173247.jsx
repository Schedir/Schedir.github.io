    ...
    <AnimatePresence>
        ...
        <div className="items-center justify-center my-auto mx-auto">
            {/* <div className="bg-[url('/media/sfondo.jpg')] bg-cover"> */}
                ...
                <div
                className='sticky top-[50vh] text-center text-red text-[15px] sm:text-[15px] md:text-[25px] lg:text-[20px] font-bold text-schedir-blue z-[30]'>
                    Navigare per mare permette di rallentare il tempo, di immergersi in esso e di unirsi al suo flusso, spezzando il regime di velocità e scadenze che impone all’essere umano una profonda lontananza dal proprio io. <br/>
