  ...
  return (
    <>
        ...
        <div ref={ref} className=" h-[200vh] my-auto mx-auto mt-[-50vh] lg:mt-[-100vh]">
          <div className='sticky top-[20vh] text-left mx-[10%] mt-[120vh]-z-30'>
              <motion.div 
                ...
                className='bg-auto bg-center bg-clip-text bg-[url("/HomeMedia/sfondosfumatura3.png")] text-transparent'>
      ...
      <motion.div style={{scaleX:-1}}>
        <motion.img 
        style={{translateX:useTransform(springscroll, [0,.8], [0, 0])}} src='/HomeMedia/IMG_costa_2.png' className='sticky bottom-[0vh] lg:bottom-[-10vh] mt-[-120vh] mb-[70vh]  z-30'/>
      </motion.div>
    </>
  )
}
