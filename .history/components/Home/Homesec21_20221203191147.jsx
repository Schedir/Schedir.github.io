...
const Homesec21 = () => {    
    ...
    return (
    <>
      <div ref={ref} className='z-20 mt-[-20vh] lg:mt-[90vh] mb-[100vh]'>
        <div className='flex justify-end z-30 mb-[0vh] mr-[7%]'>
          <motion.div  
            className='fixed top-[35vh] lg:top-[23vh] left-[10vw]'
      ...
      <div className='mb-[70vh] -z-10'>
        <motion.div
          style={{y}} 
          className='flex justify-end mx-[5vw] lg:mx-[10vw] mt-[-90vh]'>
            <div className='container h-[20vh] w-[40vw] lg:h-[60vh] lg:w-[20vw] bg-clip-padding bg-[url("/HomeMedia/IMG_2.png")] bg-bottom bg-cover'>
            </div>
        </motion.div>
        <motion.div
          className='flex justify-end mx-[5vw] lg:mx-[10vw] mt-[-20vh] mr-[20vw]'>
            <motion.div 
              style={{y2}} 
              className='container h-[30vh] w-[20vw] lg:h-[30vh] lg:w-[20vw] bg-clip-padding bg-[url("/HomeMedia/IMG_3.png")] bg-bottom bg-cover z-[10]'>
            </motion.div>
        </motion.div>
      </div>
    </>
