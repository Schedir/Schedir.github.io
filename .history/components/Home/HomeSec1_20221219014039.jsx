          ...
          <motion.div
            style={{
              ...
              height:useTransform(scrollYProgress, 
                [0, .9],
                [100 + 'vh', 30 + 'vh'])}}
          className='rounded-lg bg-[url("/HomeMedia/IMG_0121.jpg")] bg-cover z-30 mx-0' >
            <p className='font-bold text-[19px] sm:text-[15px] md:text-[20px] lg:text-[25px] text-white mx-[10vw] lg:my-[5%] text-center'>
