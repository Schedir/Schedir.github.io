            ...
            <defs>
                ...
                <linearGradient id="fifth" x1="50%" y1="0%" x2="50%" y2="100%">
                  <stop offset="0%" stop-color="#5040C9" stopOpacity="1">
                    <animate attributeName="stop-color" values="#5040C9;#2C6334;#5040C9;#BEE510" dur="8s" repeatCount="indefinite" begin='.2s' />
                  </stop>
                  <stop offset="100%" stop-color="#5040C9" stopOpacity="1">
                    <animate attributeName="stop-color" values="#5040C9;#5040C9;#00A390;#BEE510" dur="8s" repeatCount="indefinite" begin='.2s'/>
                  </stop>
                </linearGradient>
