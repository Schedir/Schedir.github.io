  ...
  return (
    <AnimatePresence>
        ...
        <div ref={ref} className="h-[200vh] items-center justify-center my-auto mx-auto">
          <div className='sticky top-[35vh] text-center text-red text-[40px] md:text-[60px] font-bold mx-[20%]'>
              <motion.div 
                style={{backgroundPositionY:useTransform(springscroll, [0, 1], [0 + '%', 100 + '%'])}} 
                className='bg-auto bg-center bg-clip-text bg-[url("/media/sfondosfumatura1.png")] text-transparent'>
