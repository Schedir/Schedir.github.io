              ...
              <defs>
                <linearGradient id="first" x1="100%" y1="100%">
                  ...
                  <stop offset="100%" stop-color="lightblue" stop-opacity=".5">
                    <animate attributeName="stop-color" values="lightblue;orange;purple;purple;blue;lightblue" dur="8s" repeatCount="indefinite" />
                    <animate attributeName="offset" values=".95;.80;.60;.40;.20;0;.20;.40;.60;.80;.95" dur="8s" repeatCount="indefinite" />    
                  </stop>
                </linearGradient>
                <linearGradient id="second"  x1="100%" y1="100%">
                  <stop offset="0%" stop-color="lightblue" stop-opacity=".5">
                    <animate attributeName="stop-color" values="lightblue;blue;red;red;purple;lightblue" dur="8s" repeatCount="indefinite" begin='first.end'/>
                  </stop>
                  <stop offset="100%" stop-color="lightblue" stop-opacity=".5">
                    <animate attributeName="stop-color" values="lightblue;orange;purple;purple;blue;lightblue" dur="8s" repeatCount="indefinite" begin='first.end'/>
                    <animate attributeName="offset" values=".95;.80;.60;.40;.20;0;.20;.40;.60;.80;.95" dur="8s" repeatCount="indefinite" begin='first.end' />    
                  </stop>
                </linearGradient>
              </defs>
          </motion.svg>
