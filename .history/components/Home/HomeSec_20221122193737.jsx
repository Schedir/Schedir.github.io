          ...
          <svg classname='overflow-clip' viewBox="0 0 4125 4151" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                ...
                <linearGradient id="fourth" x1="50%" y1="0%" x2="50%" y2="100%">
                  <stop offset="0%" stop-color="#00A390" stopOpacity="1">
                    <animate attributeName="stop-color" values="#00A390;#2C6334;#5040C9;#BEE510" dur="8s" repeatCount="indefinite" begin='.1s' />
                  </stop>
                  <stop offset="100%" stop-color="#00A390" stopOpacity="1">
                    <animate attributeName="stop-color" values="#00A390;#5040C9;#00A390;#BEE510" dur="8s" repeatCount="indefinite" begin='.1s'/>
                  </stop>
                </linearGradient>
