  ...
  return (
    <div>
      <div className='relative bg-schedir-blue z-10 '>
        ...
        <div className='flex h-screen justify-center items-center mx-[10vw] bg-schedir-blue '>
          <motion.img 
