  ...
  return (
    <AnimatePresence>
        ...
        <div className="items-center justify-center my-auto mx-auto">
            <div className="bg-[url('/media/sfondo.jpg')] bg-cover scale-115">

                <div
                className='pt-[200px] sticky top-[30%] text-center text-red text-[40px] md:text-[80px] font-bold text-schedir-blue'>
