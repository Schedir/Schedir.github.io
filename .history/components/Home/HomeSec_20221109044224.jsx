  ...
  return (
    <div>
      <div className='relative bg-schedir-blue z-10 '>
        ...
        <div className='flex h-screen justify-center items-center mx-[10vw] overflow-visible'>
          <motion.img 
          ...
          <motion.svg 
            initial={"hidden"}
            whileInView={"visible"}
            className='background-animate overflow-clip bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell'
