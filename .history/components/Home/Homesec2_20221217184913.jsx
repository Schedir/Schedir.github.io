        ...
        <div className='flex justify-center text-center z-30 mb-[0vh] lg:mr-[-13%]'>
          <motion.div  
            ...
            style={{opacity:useTransform(scrollYProgress, 
              ...
              [0 + '%', 100 + '%',100 + '%', 0 + '%'])}} >
              <motion.h2 
              className='text-transparent bg-clip-text background-animate bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell text-[25px] sm:text-[40px] md:text-[55px] lg:text-[70px] font-bold leading-none mb-9'>
              The breathe<br/> &nbsp; &nbsp; 
              &nbsp; &nbsp; of balance</motion.h2>
              <motion.span 
              className='text-transparent bg-clip-text background-animate bg-gradient-to-r from-schedir-gneon via-schedir-violet to-schedir-yell text-[15px] sm:text-[15px] md:text-[20px] lg:text-[27px]'>
