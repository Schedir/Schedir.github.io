  ...
  return (
    <>
        ...
        <div ref={ref} className='z-20 mt-[30vh] mb-[10vh] '>
              ...
              <div className='grid grid-flow-row-dense top-[80vh] lg:top-[40vh] mx-16 mr-[50vw] -z-20'>
                  <motion.div
                    style={{backgroundPositionX:useTransform(scrollYProgress, 
                      [0, 1],
                      [0 + '%', 100 + '%'])}}
                    className='mt-[-20vh] container h-[30vh] w-[40vw] col-span-2
                    lg:h-[70vh] lg:w-[20vw] bg-clip-padding bg-[url("/HomeMedia/IMG_5.png")] bg-cover bg-center z-[10] '>
                  </motion.div>
                  <motion.div
                    className='mt-[-20vh] ml-5 container h-[30vh] w-[40vw] col-span-1
                    lg:h-[30vh] lg:w-[20vw] bg-clip-padding bg-[url("/HomeMedia/IMG_5.png")] bg-cover bg-center z-[10] '>
                  </motion.div>
                  <motion.div
                    className='mt-[-20vh] ml-5 container h-[30vh] w-[40vw] col-span-2
                    lg:h-[30vh] lg:w-[20vw] bg-clip-padding bg-[url("/HomeMedia/IMG_5.png")] bg-cover bg-center z-[10] '>
                  </motion.div>
              </div>
          </div>
