...
const HomeSec1 = () => {
  ...
  return (
    <div>
      <div  className='sticky top-[-10vh] flex w-screen h-screen justify-center mb-[20vh]'>
        <motion.div 
        ref={ref}
        className='flex justify-center items-center bg-opacity-50 lg:mt-[15vh]'>
          ...
          className='bg-[url("/HomeMedia/IMG_0121.jpg")] rounded-xl bg-cover z-30 mx-0' >
            <p className='font-bold text-[19px] sm:text-[15px] md:text-[20px] lg:text-[25px] text-white mx-[10vw] my-[4%] text-center'>
