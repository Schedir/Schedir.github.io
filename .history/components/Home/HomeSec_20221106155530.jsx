...
const HomeSec = () => {
  ...
  return (
    <AnimatePresence>
        ...
        <div className='flex h-screen items-center justify-center bg-[url("/media/IMG_1367.png")] bg-cover'>
            <motion.h1 
            ...
            hover:from-schedir-yell hover:to-schedir-green hover:via-schedir-red2'>Scheir</motion.h1>
        </div>
