      ...
      <div className='mb-[70vh]'>
        <motion.div
          ...
          className='flex justify-end mx-[10vw] mt-[-90vh]'>
            <div className='container h-[20vh] w-[20vw] lg:h-[60vh] lg:w-[20vw] bg-clip-padding bg-[url("/HomeMedia/IMG_2.png")] bg-bottom bg-cover'>
            </div>
        </motion.div>
        <motion.div
          className='flex justify-end mx-[10vw] mt-[-20vh] mr-[20vw]'>
            <motion.div 
              style={{y2}} 
              className='container h-[20vh] w-[15vw] lg:h-[30vh] lg:w-[20vw] bg-clip-padding bg-[url("/HomeMedia/IMG_3.png")] bg-bottom bg-cover z-[10]'>
            </motion.div>
        </motion.div>
      </div>
    </>
