          ...
          <svg classname='overflow-clip' viewBox="0 0 4125 4151" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                ...
                <linearGradient id="third">
                  <stop offset="100%" stop-color="#BEE510" stopOpacity="1">
                    <animate attributeName="stop-color" values="#BEE510;#2C6334;#BEE510;#BEE510" dur="8s" repeatCount="indefinite" begin='0s'/>
                  </stop>
                </linearGradient>
                ...
                <linearGradient id="fifth">
                  <stop offset="100%" stop-color="#BEE510" stopOpacity="1">
                  <animate attributeName="stop-color" values="#BEE510;#BEE510;#2C6334;#BEE510" dur="8s" repeatCount="indefinite" begin='0s'/>
                  </stop>
                </linearGradient>
                <linearGradient id="sixth">
                  <stop offset="100%" stop-color="#BEE510" stopOpacity="1">
                  <animate attributeName="stop-color" values="#BEE510;#BEE510;#BEE510;#BEE510" dur="8s" repeatCount="indefinite" begin='0s'/>
                  </stop>
                </linearGradient>
