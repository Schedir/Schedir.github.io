...
const Hero = ({heading, message}) => {
  return (
    <div className='flex items-center justify-center min-h-screen mb-0 bg-cover'>
        {/* Overlay */}
        <div className='absolute top-0 left-0 right-0 bottom-0 min-h-screen bg-black/20 z-[3]'/>
        ...
        <img className="absolute w-full h-full object-cover z-[2]" src='./media/prova.jpg'>
          <source src='./media/prova.jpg'/>
        </img>
