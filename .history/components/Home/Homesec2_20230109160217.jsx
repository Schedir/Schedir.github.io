        ...
        <div className='flex justify-center  z-30 mb-[0vh] lg:mr-[-13%]'>
          <motion.div  
            ...
            style={{opacity:useTransform(scrollYProgress, 
              ...
              <motion.span 
              className='text-transparent justify-left bg-clip-text background-animate bg-gradient-to-r from-schedir-violet via-schedir-gneon to-schedir-g1 text-[15px] sm:text-[15px] md:text-[20px] lg:text-[27px]'>
