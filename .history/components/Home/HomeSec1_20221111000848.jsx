    ...
    <div>
      <div className='relative bg-schedir-blue mb-[-25vh] mt-[-10vh] -z-10'>
        <div className="items-center justify-center my-auto mx-auto">
          ...
          {/* <motion.img style={{y}} src='/HomeMedia/sfondorgb.png' className='pb-[20vh] absolute -z-20'/> */}
          {/* <motion.img style={{y}} src='/HomeMedia/sfondoblu.png' className='pb-[20vh] scale-110 z-10'/> */}
          <motion.div style={{y}}>
            <img style={{y}} src='/HomeMedia/sfondorgb.png' className='pb-[20vh] absolute -z-20'/> 
            <img style={{y}} src='/HomeMedia/sfondoblu.png' className='pb-[20vh] scale-110 z-10'/>
            <canvas id="hero-lightpass" className='opacity-50 w-full mb-[-10vh] -z-10 absolute'/>
          </motion.div>
          ...
          {/* <canvas id="hero-lightpass" className='z-20 opacity-50 w-full mt-[40vh]'/> */}
        </div>
