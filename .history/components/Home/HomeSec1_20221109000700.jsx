    ...
    <div>
      <div className='relative bg-schedir-blue my-[-25vh] -z-10'>
        <div className="items-center justify-center my-auto mx-auto">
          ...
          <div className='sticky top-[40vh] text-left text-[15px] sm:text-[15px] md:text-[20px] lg:text-[23px] text-schedir-blue z-[30] mx-[10vw] pb-[20vh]'>
          ...
          <motion.img style={{y}} src='/media/sfondo_sfum_2.png'/>
        </div>
      </div>
