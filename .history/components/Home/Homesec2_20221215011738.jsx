        ...
        <div className='flex justify-center text-center z-30 mb-[0vh] lg:mr-[-13%]'>
          <motion.div  
            ...
            style={{opacity:useTransform(scrollYProgress, 
              ...
              <motion.span 
              className='text-transparent bg-clip-text background-animate bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell text-[15px] sm:text-[15px] md:text-[20px] lg:text-[27px] mt-10'>
