  ...
  return (
    <AnimatePresence>
        ...
        <div className="items-center justify-center my-auto mx-auto">
                ...
                <div
                className='sticky top-[40vh] text-center text-[25px] sm:text-[40px] md:text-[55px] lg:text-[70px] font-bold text-schedir-blue z-[30] pb-10'>
                    Surrounded By TIME and SEA
                </div> 
                <div
                className='sticky top-[50vh] text-center text-[15px] sm:text-[15px] md:text-[25px] lg:text-[23px] font-bold text-schedir-blue z-[30] mx-[10vw]'>
