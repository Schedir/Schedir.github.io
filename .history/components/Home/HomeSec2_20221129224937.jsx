    ...
    <>
        ...
        <div ref={ref} className='z-20 mt-[0vh] mb-[70vh] '>
              <div className='flex justify-end z-30 mb-[10vh] mr-[7%]'>
                <motion.div  
                  className='fixed top-[27vh] left-[50vw]'
                  style={{opacity:useTransform(scrollYProgress, 
                    ...
                    Ogni terra raggiunta è l’inizio di molte vite: 
                    il rapporto tra la nuova terra e lo straniero è un reciproco dono.
                    Nuovi odori, nuovi suoni, nuovi sapori, nuove relazioni, nuove storie.
                    Arrivare via mare in una nuova terra e sentirsi stranieri è il privilegio che ci consente di essere liberi, di includere e di trasformarci in qualcosa di nuovo.
                    Ogni terra raggiunta è l’inizio di molte vite: <br/> il rapporto tra la nuova terra e lo straniero<br/> è un reciproco dono.<br/>
                    Nuovi odori, nuovi suoni, nuovi sapori,<br/> nuove relazioni, nuove storie.<br/>
