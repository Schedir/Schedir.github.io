    ...
    <AnimatePresence>
        ...
        <div className="items-center justify-center my-auto mx-auto">
            {/* <div className="bg-[url('/media/sfondo.jpg')] bg-cover"> */}
                <div
                className='sticky top-[45vh] text-center text-red text-[40px] md:text-[80px] font-bold text-schedir-blue z-[30]'>
                    Sea of sharing culture
                </div> 
                <motion.img style={{y}} src='/media/sfondosfumatura2.jpg'/>
