  ...
  return (
    <AnimatePresence>
        ...
        <div ref={ref} className="h-[200vh] items-center justify-center my-auto mx-auto">
          <div className='sticky top-[35vh] text-center mx-[20%]'>
              <motion.div 
                ...
                className='bg-auto bg-center bg-clip-text bg-[url("/media/sfondosfumatura.jpg")] text-transparent'>
                  ...
                  Muoversi grazie al vento è un viaggio verso le nostre radici,<br/> è un legame intimo con una Natura divina, <br/>misteriosa ed affascinante,<br/> quella stessa Natura da cui tutto si trasforma e continua a vivere, noi compresi.<br/>
