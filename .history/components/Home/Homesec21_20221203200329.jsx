...
const Homesec21 = () => {    
    ...
    <>
      ...
      <div className='mb-[70vh] -z-10'>
        <motion.div
          style={{y}} 
          className='flex justify-start mx-[5vw] lg:mx-[10vw] mt-[-90vh]'>
            <div className='container h-[20vh] w-[40vw] lg:h-[40vh] lg:w-[15vw] lg bg-clip-padding bg-[url("/HomeMedia/IMG_2.png")] bg-bottom bg-cover'>
            </div>
        </motion.div>
        <motion.div
