      ...
      <div className='relative bg-schedir-blue mb-[-25vh] mt-[-10vh] -z-30'>
        <div className="items-center justify-center my-auto mx-auto">
          ...
          <div className='h-[300vh]'>
            <img src='/HomeMedia/sfondosfumatura5.jpg' className=' -z-30 '/> 
            <canvas id="hero-lightpass" className='sticky top-[90vh] mt-[100vh] w-fit -z-10'/>
            {/* <img src='/HomeMedia/sfondoblu.png' className='absolute -z-0'/> */}
          </div>
