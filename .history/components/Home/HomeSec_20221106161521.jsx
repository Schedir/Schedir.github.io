  ...
  return (
    <AnimatePresence>
      <div className='relative'>
        ...
        <div className='fixed flex h-screen w-screen items-center justify-center bg-[url("/media/IMG_1367.png")] bg-cover z-40'>
            <motion.h1 
            style={{scale:useTransform(springscroll, [0, .5], [1.5, 0]), y:useTransform(springscroll, [0, .5], [1.5, 0])}} 
