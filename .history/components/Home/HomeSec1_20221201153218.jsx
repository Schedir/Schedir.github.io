    ...
    <div>
      ...
      <div className='relative bg-schedir-blue mb-[-25vh] mt-[-10vh] -z-30'>
        <div className="items-center justify-center my-auto mx-auto">
          ...
          {/* <motion.div style={{y}}> */}
          <div className='scroll h-[300vh] my-20vh justify-center'>
            <img src='/HomeMedia/sfondosfumatura5.jpg' className='mt-[0vh] h-[100vh] lg:h-full absolute -z-30 '/> 
            <canvas id="hero-lightpass" className='sticky bottom-[0vh] ml-[50vw] lg:ml-[90.5vh] pt-[50vh] mb-[130vh] lg:mb-[-50vh] w-full -z-10'/>
