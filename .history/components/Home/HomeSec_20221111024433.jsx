...
const HomeSec = () => {
  ...
  return (
    <div>
      <div className='relative bg-schedir-blue z-0 '>
        <div className='flex h-screen justify-center items-center mx-[20vw]'>
          <div className='absolute left-[calc(50vw-150px)] top-[54.2vh] '>
            <img src='/HomeMedia/logoalghe.png' className='absolute top-[-56vh] left-[-300px] max-w-[400%] w-[290%]'/>
            <motion.h1 
            id='stroke'
        ...
        <div className='absolute top-[40vh] -z-10'>
      ...
      <div className='relative bg-schedir-blue z-20 mt-[30vh]'>
