  ...
  return (
    <AnimatePresence>
      <div className='relative'>
        ...
        <div className='absolute left-[calc(50vw-100px)] top-[40vh] z-10'>
          <motion.h1 
      ...
      <div className='relative bg-schedir-blue'>
        <div className="h-[350vh] items-center justify-center my-auto mx-auto">
          <div className='sticky top-[35vh] text-right mx-[20%]'>
              <motion.div 
                style={{backgroundPositionY:useTransform(springscroll, [0, 1], [-10 + '%', 120 + '%'])}}
                className='bg-auto bg-center bg-clip-text bg-[url("/media/sfondo_sfum2.png")] text-transparent'>
