            ...
            <defs>
                <linearGradient id="first" x1="50%" y1="0%" x2="50%" y2="100%">
                  <stop offset="0%" stop-color="#00A390" stopOpacity="1">
                    <animate attributeName="stop-color" values="#00A390;#5040C9;#BEE510;#081221;#00A390" dur="8s" repeatCount="indefinite" begin='0s' />
                  </stop>
                  <stop offset="100%" stop-color="#00A390" stopOpacity="1">
                    <animate attributeName="stop-color" values="#00A390;#081221;#2C6334;#5040C9;#00A390" dur="8s" repeatCount="indefinite" begin='0s'/>
                  </stop>
                </linearGradient>
                <linearGradient id="second" x1="50%" y1="0%" x2="50%" y2="100%">
                  <stop offset="0%" stop-color="#BEE510" stopOpacity="1">
                    <animate attributeName="stop-color" values="#BEE510;#081221;#2C6334;#00A390;#BEE510" dur="8s" repeatCount="indefinite" begin='0s' />
                  </stop>
                  <stop offset="100%" stop-color="#BEE510" stopOpacity="1">
                    <animate attributeName="stop-color" values="#BEE510;#00A390;#5040C9;#081221;#BEE510" dur="8s" repeatCount="indefinite" begin='0s'/>
                  </stop>
                </linearGradient>
                <linearGradient id="third" x1="50%" y1="0%" x2="50%" y2="100%">
                  <stop offset="0%" stop-color="#2C6334" stopOpacity="1">
                    <animate attributeName="stop-color" values="#2C6334;#BEE510;#5040C9;#081221;#2C6334" dur="8s" repeatCount="indefinite" begin='.2s' />
                  </stop>
                  <stop offset="100%" stop-color="#2C6334" stopOpacity="1">
                    <animate attributeName="stop-color" values="#2C6334;#0812210;#00A390;#BEE510;#2C6334" dur="8s" repeatCount="indefinite" begin='.2s'/>
                  </stop>
                </linearGradient>
                <linearGradient id="fourth" x1="50%" y1="0%" x2="50%" y2="100%">
                  <stop offset="0%" stop-color="#00A390" stopOpacity="1">
                    <animate attributeName="stop-color" values="#00A390;#5040C9;#BEE510;#081221;#00A390" dur="8s" repeatCount="indefinite" begin='.1s' />
                  </stop>
                  <stop offset="100%" stop-color="#00A390" stopOpacity="1">
                    <animate attributeName="stop-color" values="#00A390;#081221;#2C6334;#5040C9;#00A390" dur="8s" repeatCount="indefinite" begin='.1s'/>
                  </stop>
                </linearGradient>
                <linearGradient id="fifth" x1="50%" y1="0%" x2="50%" y2="100%">
                  <stop offset="0%" stop-color="#5040C9" stopOpacity="1">
                    <animate attributeName="stop-color" values="#5040C9;#081221;#00A390;#00A390;#5040C9" dur="8s" repeatCount="indefinite" begin='.2s' />
                  </stop>
                  <stop offset="100%" stop-color="#5040C9" stopOpacity="1">
                    <animate attributeName="stop-color" values="#5040C9;#5040C9;#00A390;#5040C9" dur="8s" repeatCount="indefinite" begin='.2s'/>
                  </stop>
                </linearGradient>
                <linearGradient id="sixth" x1="50%" y1="0%" x2="50%" y2="100%">
                  <stop offset="0%" stop-color="#BEE510" stopOpacity="1">
                    <animate attributeName="stop-color" values="#BEE510;#081221;#2C6334;#00A390;#BEE510" dur="8s" repeatCount="indefinite" begin='.2s' />
                  </stop>
                  <stop offset="100%" stop-color="#BEE510" stopOpacity="1">
                    <animate attributeName="stop-color" values="#BEE510;#00A390;#5040C9;#081221;#BEE510" dur="8s" repeatCount="indefinite" begin='.2s'/>
                  </stop>
                </linearGradient>
                <linearGradient id="seventh" x1="50%" y1="0%" x2="50%" y2="100%">
                  ...
                  <stop offset="100%" stop-color="#5040C9" stopOpacity="1">
                    <animate attributeName="stop-color" values="#5040C9;#2C6334;#5040C9;#081221;#5040C9" dur="8s" repeatCount="indefinite" begin='.2s'/>
                  </stop>
                </linearGradient>
              </defs>
          </svg>
