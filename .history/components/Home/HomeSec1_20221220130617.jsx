        ...
        <div  className='sticky top-[-15vh] flex w-screen h-screen justify-center mb-[20vh]'>
          ...
          className='bg-opacity-50 lg:mt-[15vh]'>
            <video
                ...
                muted
                >
                  <source src="/HomeMedia/loop_gabbiano.mp4" />
            </video>
            <motion.div
              style={{
                ...
                height:useTransform(scrollYProgress, 
                  [0, 1],
                  [115 + 'vh', 30 + 'vh'])}}
            className='rounded-xl bg-cover z-30 flex justify-around' >
            
              <p className='absolute mt-20 font-bold text-[19px] sm:text-[15px] md:text-[20px] lg:text-[25px] text-white m-auto text-center'>
