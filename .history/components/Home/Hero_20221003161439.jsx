...
const Hero = ({heading, message}) => {
  return (
    <div className='flex items-center justify-center min-h-screen mb-0 
    '>
        {/* Overlay */}
        <div className='bg-[url('/media/prova.jpg')] ' ></div>
        ...
        {/* <img className="fixed bg-scroll object-cover z-[0]" src='./media/prova.jpg'/> */}
