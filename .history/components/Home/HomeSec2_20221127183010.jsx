        ...
        <div className='z-20 mt-[40vh] mb-[60vh] '>
              <div className='flex justify-end text-right z-30 mb-[10vh] mx-[7%]'>
                <motion.div >
                    ...
                    viewport={{once:false, amount:0.9, margin:['-150px 150px 0px 0px']}}className='text-transparent bg-clip-text background-animate bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell text-[15px] sm:text-[15px] md:text-[20px] lg:text-[29px]'>
