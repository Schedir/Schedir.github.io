            ...
            <motion.div
              style={{
                ...
                height:useTransform(scrollYProgress, 
                  [0, 1],
                  [115 + 'vh', 30 + 'vh'])}}
            className='bg-[url("/HomeMedia/loop_gabbiano.mp4")] rounded-xl bg-cover z-30 flex justify-around  overflow-hidden' >
              <motion.p 
              style={{scale:useTransform(springscroll, [0, .9], [100 + '%', 250 + '%'])}}
              className='font-bold text-[19px] sm:text-[15px] md:text-[20px] lg:text-[25px] text-white m-auto text-center'>
