            ...
            width="7293" height="1418" viewBox="0 0 7293 1418"  xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                ...
                <linearGradient id="second">
                  <stop offset="0%" stop-color="lightblue" stop-opacity=".5">
                    <animate attributeName="stop-color" values="lightblue;purple;red;blue;lightblue" dur="8s" repeatCount="indefinite" begin='.2s' />
                  </stop>
                  <stop offset="100%" stop-color="lightblue" stop-opacity=".5">
                  <animate attributeName="stop-color" values="lightblue;purple;orange;lightblue" dur="8s" repeatCount="indefinite" begin='.2s'/>
                  </stop>
                </linearGradient>
              </defs>
          </motion.svg>
