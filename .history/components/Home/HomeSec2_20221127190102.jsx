    ...
    <>
        ...
        <div ref={ref} className='z-20 mt-[0vh] mb-[60vh] '>
              <div className='flex justify-end text-right z-30 mb-[10vh] mx-[7%]'>
                <motion.div className='fixed top-[40vh]' >
                    <motion.h2 
                    // initial={"offscreen"}
                    ...
                    //   [0, .5, 1],
                    //   [0 + '%', -100 + '%', 0 + '%'])}}
                    className='text-transparent bg-clip-text background-animate bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell text-[25px] sm:text-[40px] md:text-[55px] lg:text-[80px] font-bold '>
