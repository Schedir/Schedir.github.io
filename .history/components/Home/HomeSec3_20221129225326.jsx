          ...
          <div className='sticky top-[30vh] text-left mx-[10%] mt-[30vh] -z-30'>
              <motion.div 
                ...
                className='bg-auto bg-center bg-clip-text bg-[url("/media/sfondosfumatura2.png")] text-transparent'>
                  ...
                  Moving together with the wind is a journey towards our roots.
                  It is an intimate bond with a divine, mysterious and fascinating Nature.
                  The same Nature from which everything is transformed and keeps living, including us. Everything is in harmony when the boat dances with the wind.
