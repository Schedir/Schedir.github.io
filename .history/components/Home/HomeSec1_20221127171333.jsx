    ...
    <div>
      <div className='relative bg-schedir-blue mb-[-25vh] mt-[-10vh] -z-30'>
        <div className="items-center justify-center my-auto mx-auto">
          <div className='sticky top-[35vh] text-left text-[25px] sm:text-[40px] md:text-[55px] lg:text-[70px] font-bold text-schedir-blue z-[10] mx-[10vw]'>
          ...
          <motion.div style={{y}}>
            ...
            <img src='/HomeMedia/sfondoblu.png' className='pb-[20vh] z-30'/>
