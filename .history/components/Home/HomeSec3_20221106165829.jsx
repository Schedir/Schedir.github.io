    ...
    <AnimatePresence>
      <div className='relative bg-schedir-blue'>
        <div ref={ref} className=" h-[200vh] items-center justify-center my-auto mx-auto">
          ...
          <motion.div className=' max-w-lg max-h-lg mx-[10vw] mt-[40vh] rounded-lg overflow-hidden object-cover' style={{y}}>
            <motion.img style={{opacity:useTransform(springscroll, [0, .5, 1], [0, 1, 0])}} src='/media/IMG_1367.png'/>
          </motion.div>
        </div>
      </div>
    </AnimatePresence>
