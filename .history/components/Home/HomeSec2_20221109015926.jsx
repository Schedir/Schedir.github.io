  ...
  return (
    <>
        ...
        <div className=' bg-schedir-blue -z-20 mt-[40vh] mb-[-40vh] mx-[10%]'>
            <div className='flex-inline justify-start mx-5 z-20'>
                <motion.div >
                    <h2 
            ...
            <div className='max-w-lg max-h-lg mx-[10vw] mt-[60vh] 
                     rounded-md overflow-hidden object-cover'>
              <motion.div
                  // style={{y}}
                  
                      className='flex justify-end mt-[-30vh] -z-10'>
                      <motion.img style={{backgroundPositionY:useTransform(springscroll, [0, 1], [-5 + '%', 120 + '%'])}}
