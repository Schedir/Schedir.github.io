  ...
  return (
    <div>
      <div className='relative bg-schedir-blue z-10 '>
        ...
        <div className='flex h-screen justify-center items-center mx-[10vw]background-animate bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell bg-c'>
          <motion.svg 
                initial={"hidden"}
                whileInView={"visible"}
