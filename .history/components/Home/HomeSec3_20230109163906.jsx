        ...
        <div ref={ref} className='z-20 mt-[30vh] mb-[10vh] '>
              ...
              <div className='grid grid-rows-2 grid-flow-col gap-3 top-[80vh] lg:top-[40vh] mx-16 mr-[50vw] -z-20'>
                  ...
                  <motion.div
                    ...
                    lg:h-[35vh] lg:w-[24vw] bg-clip-padding bg-[url("/HomeMedia/IMG_5.png")] bg-cover bg-center z-[10] '>
                  </motion.div>
                  <motion.div
                    className=' container h-[30vh] w-[40vw] row-span-2 col-span-2
                    lg:h-[39vh] lg:w-[24vw] bg-clip-padding bg-[url("/HomeMedia/IMG_5.png")] bg-cover bg-center z-[10] '>
                  </motion.div>
              </div>
          </div>
    </>
