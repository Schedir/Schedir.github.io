...
const Homesec21 = () => {    
    ...
    const y = useParallax(springscroll, -200);
    ...
    <>
      ...
      <div ref={ref} className='z-20 mt-[-20vh] mb-[70vh] '>
            ...
            <div>
                <motion.div
                  ...
                  className='flex justify-end mx-[10vw] mt-[-20vh] '>
                    <div className='container h-[60vh] w-[20vw] bg-clip-padding bg-[url("/HomeMedia/IMG_2.png")] bg-bottom bg-cover z-[10]'>
                    </div>
                </motion.div>
                <motion.div
                  className='flex justify-end mx-[10vw] mt-[-20vh] mr-[20vw]'>
                    <motion.div 
                      style={{y2}} 
                      className='container h-[30vh] w-[20vw] bg-clip-padding bg-[url("/HomeMedia/IMG_3.png")] bg-bottom bg-cover'>
                    </motion.div>
                </motion.div>
            </div>
        </div>
