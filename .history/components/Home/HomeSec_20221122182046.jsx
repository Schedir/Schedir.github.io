    ...
    <div>
      <div className='relative bg-schedir-blue z-0 '>
        <div className='flex h-screen justify-center items-center mx-[20vw]'>
          ...
          <motion.img 
                  className='h-screen left-[33vw]'
                  src='/HomeMedia/IMG_2.png' width="14%"/>
          <svg classname='overflow-hidden' width="4125" height="4151" viewBox="0 0 4125 4151" fill="none" xmlns="http://www.w3.org/2000/svg">
