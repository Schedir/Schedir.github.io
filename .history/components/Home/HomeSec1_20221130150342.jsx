  ...
  return (
    <div>
      <div className='flex justify-center items-center'>
        <div className='bg-fixed bg-[url("/media/Schedir_1.JPG")] bg-cover w-screen bg-opacity-25 h-64 z-30 mx-0' >
          <p className='font-bold text-[15px] sm:text-[15px] md:text-[20px] lg:text-[27px] text-schedir-blue mx-[10vw] my-[5%]'>
      ...
      <div className='relative bg-schedir-blue mb-[-25vh] mt-[-10vh] -z-30'>
        <div className="items-center justify-center my-auto mx-auto">
          ...
          <div className='h-[300vh] my-20vh justify-center'>
            ...
            <canvas id="hero-lightpass" className='sticky bottom-[0vh] ml-[90.5vh] pt-[50vh] mb-[60vh] w-full -z-10'/>
            <img src='/HomeMedia/sfondoblu.png' className='absolute top-48 -z-0'/>
          </div>
