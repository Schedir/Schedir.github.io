  ...
  return (
    <AnimatePresence>
      <div className='relative '>
        <div ref={ref} className=" h-[200vh] items-center justify-enmd my-auto mx-auto">
          <div className='sticky top-[35vh] text-left mx-[10%] mt-[-60vh] z-20'>
              <motion.div 
          ...
          <motion.div 
          className='flex justify-end max-w-lg max-h-lg mx-[10vw] mt-[60vh] 
