...
const Homesec21 = () => {    
    ...
    <>
      ...
      <div ref={ref} className='z-20 mt-[0vh] mb-[70vh] '>
            ...
            <div className=' -z-20'>
                <motion.div
                  className='mt-[-20vh] flex justify-end mx-[10vw]'>
                    <div className='container h-[60vh] w-[20vw] bg-clip-padding bg-[url("/HomeMedia/IMG_2.png")] bg-bottom bg-cover'>
                    </div>
                </motion.div>
                <motion.div
                  className='mt-[-30vh] mr-[20vw] flex justify-end mx-[10vw]'>
                    <div className='container h-[60vh] w-[20vw] bg-clip-padding bg-[url("/HomeMedia/IMG_3.png")] bg-bottom bg-cover'>
                    </div>
                </motion.div>
            </div>
        </div>
