...
const Homesec21 = () => {    
    ...
    <>
      ...
      <div ref={ref} className='z-20 mt-[-40vh] lg:mt-[50vh] mb-[70vh] '>
            <div className='flex justify-end z-30 mb-[10vh] lg:h-screen mr-[7%]'>
              <motion.div  
            ...
            <div>
                <motion.div
                  style={{y}} 
                  className='flex justify-end mx-[10vw] mt-[-20vh] lg:mt-[-60vh]'>
