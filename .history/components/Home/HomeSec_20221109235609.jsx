  ...
  return (
    <div>
      <div className='relative bg-schedir-blue z-0 '>
        ...
        <div className='flex h-screen justify-center items-center mx-[20vw] -z-50 '>
        ...
        <div className='absolute top-20 z30'>
          <video className='w-screen'  controls loop muted>
            <source src="/HomeMedia/loopintro.mov" type="video/mp4" />
          </video>
        </div>
      </div> 

      <div className='relative bg-schedir-blue z-20'>
