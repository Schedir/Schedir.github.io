...
const HomeSec = () => {
  ...
  return (
    <div>
      <div className='sticky top-[-44vh] left-[20vw] bg-schedir-blue '>
        <div className='flex h-screen justify-center items-center mx-[20vw]'>
          <motion.div className=' h-screen z-[99] ' 
          style={{
            scale:useTransform(springscroll, [0, .1], [.8, .1]),
            x:useTransform(springscroll, [0,.1],[0,-650])
          }}  
          >
