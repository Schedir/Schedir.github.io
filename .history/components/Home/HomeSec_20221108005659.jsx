    ...
    <AnimatePresence>
      ...
      <div className='relative bg-schedir-blue'>
        ...
        <motion.div 
            ...
            viewport={{once:false, amount:0.5, margin:['-50px 0px 0px 0px']}}
            className='flex justify-end mx-[5vw] my-5 mt-[25vh] z-50'>
                <button 
                  type="button" 
                  whileHover={{ scale: 1.2 }} 
                  whileTap={{ scale: 0.9 }}
                  className=" text-left inline-flex items-center ">
                    <span className='mx-2 text-white'> Scopri la rotta </span>
                    <motion.span 
                    variants={arrowdx}
        ...
        <motion.div 
            ...
            whileInView={"onscreen"}
            viewport={{once:false, amount:0.5, margin:['-50px 0px 0px 0px']}}
            className='flex justify-start mx-[5vw] my-5 mt-[65vh] z-50 rotate-90'>
                <button 
                  type="button" 
                  whileHover={{ scale: 1.2 }} 
                  whileTap={{ scale: 0.9 }}
                  className=" text-left inline-flex items-center ">
                    ...
                    variants={arrowbx}
                    className='background-animate bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell 
                    rounded-full p-[1.9px] overlflow-clip rotate-90'>
                      <svg aria-hidden="true" className="w-14 h-10 rounded-full rotate-90" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                    </motion.span>
