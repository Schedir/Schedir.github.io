  ...
  return (
    <div>
      <div className='flex justify-center items-center bg-opacity-50 lg:mt-[35vh]'>
        <div className='bg-fixed bg-[url("/HomeMedia/Schedir_1.JPG")] bg-right bg-cover w-screen h-[50vh] z-30 mx-0' >
          <p className='font-bold text-[19px] sm:text-[15px] md:text-[20px] lg:text-[27px] text-transparent mx-[10vw] lg:my-[10%]
