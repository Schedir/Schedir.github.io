  ...
  return (
    <>
        ...
        <div ref={ref} className='z-20 mt-[0vh] mb-[100vh] '>
              ...
              <div className=' top-[80vh] lg:top-[40vh] mx-10 -z-20'>
                  <motion.div
                    // style={{x:useTransform(scrollYProgress, 
                    //   [0, .4,.6, 1],
                    //   [-100 + '%', 0 + '%',0 + '%', -100 + '%'])}}
                    className='mt-[-20vh] container h-[30vh] w-[50vw] 
                    lg:h-[70vh] lg:w-[13vw] bg-clip-padding bg-[url("/HomeMedia/IMG_1.png")] bg-bottom bg-cover z-[10]'>
                    {/* <motion.img 
