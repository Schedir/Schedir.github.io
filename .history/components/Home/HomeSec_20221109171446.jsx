...
const HomeSec = () => {
  ...
  return (
    <div>
      ...
      <div className='relative bg-schedir-blue z-30'>
        <div className="h-[200vh] items-center justify-center my-auto mx-auto">
            <div className='sticky top-[35vh] text-right mx-[20%] bg-schedir-blue'>
                  <div className='flex'>
                    <motion.div 
            ...
            <div className='sticky top-[45vh] text-right mx-[20%] mt-[30vh]'>
              <div className='z-10'>
                <motion.div 
                    initial={"offscreen"}
                    whileInView={"onscreen"}
                    viewport={{once:false, amount:0.5, margin:['-250px 350px 0px 0px']}}
