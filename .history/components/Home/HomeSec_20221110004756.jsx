      ...
      <div className='relative bg-schedir-blue z-0 '>
        <div className='flex h-screen justify-center items-center mx-[20vw]'>
          <div className='absolute left-[calc(50vw-150px)] top-[54.2vh] '>
            ...
            hover:from-schedir-yell hover:to-schedir-green hover:via-schedir-red2'>Posidonia</motion.h1>
          </div>
        </div>
        ...
        <div className='absolute top-[70vh] -z-20'>
          <div className='container overflow-hidden h-[30vh] object-none object-bottom w-full'>
