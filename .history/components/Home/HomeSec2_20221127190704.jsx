              ...
              <div className='flex justify-end z-30 mb-[10vh] mx-[7%]'>
                <motion.div  
                  ...
                  style={{opacity:useTransform(scrollYProgress, 
                    ...
                    className='text-transparent bg-clip-text text-left  background-animate bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell text-[15px] sm:text-[15px] md:text-[20px] lg:text-[29px] pl-[40vw]'>
