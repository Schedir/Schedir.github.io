  ...
  return (
    <div>
      ...
      <div className='relative bg-schedir-blue z-20 mt-[20vh]'>
        <div className="h-[300vh] items-center justify-center my-auto mx-auto">
            <div className='sticky top-[35vh] text-right mx-[10%]'>
                  <div className='flex'>
                    <motion.div 
                      style={{backgroundPositionY:useTransform(springscroll, [0, 1], [-10 + '%', 120 + '%'])}}
                      className='bg-auto bg-center bg-clip-text bg-[url("/HomeMedia/back_sec2.png")] text-transparent '>
            ...
            <div className='sticky top-[47vh] text-right mx-[20%] z-30'>
              <div className='z-10'>
                <motion.div 
                    initial={"offscreen"}
                    whileInView={"onscreen"}
                    viewport={{once:false, amount:1, margin:['-300px 350px 0px 0px']}}
