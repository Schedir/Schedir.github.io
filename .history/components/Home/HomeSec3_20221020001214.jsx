        ...
        <div className="h-[1000px] items-center justify-center my-auto mx-auto">
            {/* <div className="bg-[url('/media/sfondo.jpg')] bg-cover"> */}
                <motion.div className='sticky top-[30%] text-center text-red text-[40px] md:text-[80px] font-bold'>
                    <motion.span 
                    style={{backgroundPositionx:useTransform(scrollYProgress, [0, 1], [0 + 'px', 20000 + 'px']),
                    backgroundImage:'/media/sfondosfumatura.jpg'}} 
                    className='bg-clip-text bg-[url("/media/sfondosfumatura.jpg")] text-transparent'>
                      Sea of culture 
                    </motion.span>
                </motion.div> 
