    ...
    <div>
      <div className='relative bg-schedir-blue mb-[-25vh] mt-[-10vh] -z-10'>
        <div className="items-center justify-center my-auto mx-auto">
          ...
          <motion.div style={{y}}>
            <img src='/HomeMedia/sfondorgb.png' className='pb-[20vh] -z-20'/> 
            <img src='/HomeMedia/sfondoblu.png' className='pb-[20vh] z-10'/>
            {/* <div className='absolute top-[165vh] left-0 right-0 bottom-0 h-[40vh] bg-gradient-to-b from-transparent to-schedir-blue z-[30]'/> */}
            <canvas id="hero-lightpass" className='opacity-50 w-full mt-[7.3vh] -z-10 '/>
          </motion.div>
        </div>
