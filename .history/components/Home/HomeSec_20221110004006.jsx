  ...
  return (
    <div>
      <div className='relative bg-schedir-blue z-0 '>
        ...
        <div className='absolute top-[70vh] -z-20'>
          <div className='container overflow-hidden h-[55.5vh] object-none object-bottom w-full'>
            <div className='fixed bottom-0 w-full bg-schedir-blue z-10'/>
            <video className='scale-[135%] mt-[-60vh] -z-10' autoPlay loop muted >
