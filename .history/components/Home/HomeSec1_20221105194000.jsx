...
const HomeSec1 = () => {
  ...
  const y = useTransform(springscroll, [0, .8], [350, 0])

  return (
    <AnimatePresence>

        <div className="items-center justify-center my-auto mx-[20vw]">

                <div
                className='sticky top-[35vh] text-left text-[25px] sm:text-[40px] md:text-[55px] lg:text-[70px] font-bold text-schedir-blue z-[30]'>
                    Surrounded by time and sea
                </div> 
                <div
                className='sticky top-[50vh] text-center text-[15px] sm:text-[15px] md:text-[20px] lg:text-[23px] text-schedir-blue z-[30] mx-[10vw]'>
