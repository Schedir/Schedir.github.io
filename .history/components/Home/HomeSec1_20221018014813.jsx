...
const HomeSec1 = () => {
  ...
  return (
    <AnimatePresence>
        ...
        <div className='h-[1000px] mx-auto bg-clip-text bg-[url("/media/hero_background_medium.png")]'>
            ...
            <div className='sticky top-[30%]'>
                <h2 
                className='text-center text-transparent text-[40px] md:text-[80px] font-bold bg-clip-text bg-[url("/media/hero_background_medium.png")]'>Intro</h2>
