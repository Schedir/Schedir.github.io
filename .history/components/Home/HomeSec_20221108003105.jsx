    ...
    <AnimatePresence>
      ...
      <div className='relative bg-schedir-blue'>
        ...
        <motion.div 
            ...
            className='flex justify-end mx-[5vw] my-5 mt-[25vh] z-20 bg-schedir-blue'>
                <motion.button 
                  type="button" 
                  variants={arrowdx}
                  ...
                  className="background-animate bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell 
                    rounded-full p-[1.9px] overlflow-clip text-center inline-flex items-center ">
        ...
        <div className='flex justify-end mx-[5vw] my-5 mt-[-20vh]bg-schedir-blue'>
          <span className='absolute bottom-10 text-white -z-30'> Scopri la rotta </span>
        </div>
      </div>
    </AnimatePresence>
  )
