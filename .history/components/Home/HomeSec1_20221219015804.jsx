...
const HomeSec1 = () => {
  ...
  return (
    <div>
      <div  className='sticky top-[-15vh] flex w-screen h-screen justify-around mb-[20vh]'>
        <motion.div 
        ref={ref}
        className='bg-opacity-50 lg:mt-[15vh]'>
          <motion.div
            style={{
              ...
              height:useTransform(scrollYProgress, 
                [0, 1],
                [115 + 'vh', 30 + 'vh'])}}
          className='bg-[url("/HomeMedia/IMG_0121.jpg")] rounded-xl bg-cover z-30 ' >
            <p className='font-bold text-[19px] sm:text-[15px] md:text-[20px] lg:text-[25px] text-white mx-[10vw] text-center'>
