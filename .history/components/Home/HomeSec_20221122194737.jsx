    ...
    <div>
      <div className='relative bg-schedir-blue z-0 '>
        <div className='flex h-screen justify-center items-center mx-[20vw]'>
          ...
          <div className='absolute top-[50vh] left-0 right-0 bottom-0 h-[10vh] bg-gradient-to-b from-transparent to-schedir-blue z-[30]'/>
            ...
            <defs>
                <linearGradient id="first" x1="50%" y1="0%" x2="50%" y2="100%">
                  <stop offset="0%" stop-color="#00A390" stopOpacity="1">
                    <animate attributeName="stop-color" values="#00A390;#2C6334;#5040C9;#081221;#00A390" dur="8s" repeatCount="indefinite" begin='0s' />
                  </stop>
                  <stop offset="100%" stop-color="#00A390" stopOpacity="1">
                    <animate attributeName="stop-color" values="#00A390;#081221;#BEE510;#2C6334;#00A390" dur="8s" repeatCount="indefinite" begin='0s'/>
                  </stop>
                </linearGradient>
                <linearGradient id="second" x1="50%" y1="0%" x2="50%" y2="100%">
                  <stop offset="0%" stop-color="#BEE510" stopOpacity="1">
                    <animate attributeName="stop-color" values="#BEE510;#2C6334;#5040C9;#081221;#BEE510" dur="8s" repeatCount="indefinite" begin='0s' />
                  </stop>
                  <stop offset="100%" stop-color="#BEE510" stopOpacity="1">
                    <animate attributeName="stop-color" values="#BEE510;#081221;#00A390;#2C6334;#BEE510" dur="8s" repeatCount="indefinite" begin='0s'/>
                  </stop>
                </linearGradient>
                <linearGradient id="third" x1="50%" y1="0%" x2="50%" y2="100%">
                  <stop offset="0%" stop-color="#2C6334" stopOpacity="1">
                    <animate attributeName="stop-color" values="#2C6334;#2C6334;#5040C9;#2C6334" dur="8s" repeatCount="indefinite" begin='.2s' />
                  </stop>
                  <stop offset="100%" stop-color="#2C6334" stopOpacity="1">
                    <animate attributeName="stop-color" values="#2C6334;#5040C9;#00A390;#2C6334" dur="8s" repeatCount="indefinite" begin='.2s'/>
                  </stop>
                </linearGradient>
