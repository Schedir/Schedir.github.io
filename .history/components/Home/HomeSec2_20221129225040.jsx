              ...
              <div className='flex justify-end z-30 mb-[10vh] mr-[7%]'>
                <motion.div  
                  ...
                  style={{opacity:useTransform(scrollYProgress, 
                    ...
                    the relationship between the new land and the foreigner  <br/> is a mutual gift.   <br/>
                    New smells, new sounds, new flavors, new relationships, new stories. 
                    Arriving by sea in a new land and feeling like a foreigner is the privilege that allows us to be free, to include and to transform ourselves into something new.
