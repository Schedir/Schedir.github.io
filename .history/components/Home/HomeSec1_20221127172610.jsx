    ...
    <div>
      <div className='relative bg-schedir-blue mb-[-25vh] mt-[-10vh] -z-30'>
        <div className="items-center justify-center my-auto mx-auto">
          <div className='sticky top-[35vh] text-left text-[25px] sm:text-[40px] md:text-[55px] lg:text-[70px] font-bold text-schedir-blue -z-20 mx-[10vw]'>
              Surrounded by time and sea</div> 
          <div className='sticky top-[40vh] md:top-[50vh] text-left text-[15px] sm:text-[15px] md:text-[20px] lg:text-[23px] text-schedir-blue -z-20 mx-[10vw]'>
          ...
          {/* <motion.div style={{y}}> */}
            <img src='/HomeMedia/sfondosfumatura5.jpg' className='mt-[-80vh] absolute -z-30 h-[100%]'/> 
            <canvas id="hero-lightpass" className='opacity-100 w-full -z-10 mt-[40vh]'/>
            <img src='/HomeMedia/sfondoblu.png' className='mt-[-20vh] pb-[25vh] -z-0 h-[120%]'/>
