      ...
      <div className='relative bg-schedir-blue z-0 '>
        <div className='flex h-screen justify-center items-center mx-[20vw]'>
          <div className='absolute left-[calc(50vw-150px)] top-[54.2vh] '>
            <img src='/HomeMedia/logoalghe0.png' className='absolute top-[-30vh] left-[calc(50%-200px)] max-w-[120%] w-[290%]'/>
            <motion.h1 
            id='stroke'
            ...
            bg-gradient-to-r from-schedir-g1 via-schedir-g2 via-schedir-g4 to-schedir-g3 
