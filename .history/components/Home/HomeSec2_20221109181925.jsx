...
const HomeSec2 = () => {
  ...
  return (
    <>
        ...
        <div className=' bg-schedir-blue z-0 mt-[40vh] mb-[-40vh] mx-[10%]'>
            <div className='flex-inline justify-end mx-5 z-10'>
            ...
            <motion.div
              className='flex justify-start mt-[-40vh] -z-10
        ...
        <div>
      <motion.img 
            style={{translateX:useTransform(springscroll, [0,.8], [0, 0])}} src='/HomeMedia/IMG_costa_2.png' className='sticky bottom-0 mt-[-90vh] z-30'/>
      </div>
    </>
  )
}
