...
const HomeSec = () => {
  ...
  return (
    <AnimatePresence>
        ...
        <div className='fixed w-screen h-screen items-center justify-center bg-[url("/media/IMG_1367.png")] bg-cover'>
            <motion.h1 
        ...
        <div className="h-[200vh] items-center justify-center my-auto mx-auto mt-[-40vh] bg-schedir-blue">
