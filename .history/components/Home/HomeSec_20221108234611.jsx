      ...
      <div className='relative bg-schedir-blue'>
        ...
        <motion.div 
            ...
            className='flex justify-end mx-[5vw] my-5 mt-[25vh] z-50'>
                <button 
                  type="button" 
                  className="Walid text-left inline-flex items-center ">
                    <span className='mx-4 text-white z-0'> Scopri la rotta</span>
                    <div className='block bg-schedir-blue mx-9 z-10'>
                      <motion.span 
                      variants={arrowdx}
