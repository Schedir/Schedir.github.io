...
const Homesec21 = () => {    
    ...
    const springscroll = useSpring(scrollYProgress1, { stiffness: 500, damping: 150 })
    ...
    <>
      ...
      <div ref={ref} className='z-20 mt-[30vh] lg:mt-[60vh] mb-[70vh] '>
            <div className='flex justify-end z-30 mb-[0vh] lg:h-screen mr-[7%]'>
              <motion.div  
