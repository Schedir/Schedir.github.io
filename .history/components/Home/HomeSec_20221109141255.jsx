              ...
              <defs>
                <linearGradient id="first">
                  <stop offset="0%" stop-color="lightblue" stop-opacity=".5">
                    <animate attributeName="stop-color" values="lightblue;blue;red;purple;lightblue" dur="8s" repeatCount="indefinite" begin='0s' />
                  </stop>
                ...
                <linearGradient id="second">
                  <stop offset="0%" stop-color="lightblue" stop-opacity=".5">
                    <animate attributeName="stop-color" values="lightblue;purple;red;purple;lightblue" dur="8s" repeatCount="indefinite" begin='.2s' />
                  </stop>
                  <stop offset="100%" stop-color="lightblue" stop-opacity=".5">
