  ...
  return (
    <>
        ...
        <div className=' bg-schedir-blue -z-20 mt-[40vh] mb-[-40vh] mx-[10%]'>
            ...
            <motion.div
              className='flex justify-end mt-[-40vh] -z-10 overflow-hidden'>
              <div className='container w-[80vw] h-[40vh]'>
                <motion.img 
                  style={{backgroundPositionY:useTransform(springscroll, [0, 1], [-15 + '%', 120 + '%'])}}
