...
const HomeSec2 = () => {
  ...
  return (
    <>
        ...
        <div className='flex bg-schedir-blue -z-20 mt-[40vh] mb-[40vh] mx-[10%]'>
              <div className=' justify-end text-right mx-5 z-10 mb-[10vh]'>
                <motion.div >
                    <h2 
              ...
              <div className='justify-start'>
                  <motion.div
                    style={{y}}
                    className=' justify-start mt-[-20vh] -z-0
