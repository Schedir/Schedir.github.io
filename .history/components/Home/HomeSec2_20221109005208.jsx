        ...
        <div className='flex items-center bg-schedir-blue -z-20 my-[20vh]'>
            <div ref={ref} className='container flex mx-5 '>
                ...
                className='absolute left-[65%]'>
                    <h2 className='text-transparent bg-clip-text background-animate
          bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell text-[3em] text-bold'>Testo</h2>
