...
const Homesec2 = () => {    
    ...
    const y = useParallax(springscroll, -150);
    ...
    <>
        ...
        <div className='flex justify-center z-30 mb-[0vh] lg:mr-[-13%]'>
          <motion.div  
            ...
            style={{opacity:useTransform(scrollYProgress, 
              ...
              <motion.div 
              className='text-transparent text-right bg-clip-text background-animate bg-gradient-to-r from-schedir-violet via-schedir-gneon to-schedir-g1 text-[15px] sm:text-[15px] md:text-[20px] lg:text-[27px]'>
      ...
      <div className='mb-[100vh] mt-[-110vh] -z-10 '>
        <motion.div
          style={{y}} 
          className='flex justify-start mx-[5vw] lg:mx-[5vw] mt-[40vh]'>
