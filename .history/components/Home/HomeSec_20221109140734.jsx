            ...
            width="7293" height="1418" viewBox="0 0 7293 1418"  xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                ...
                <linearGradient id="second">
                  <stop offset="0%" stop-color="lightblue" stop-opacity=".5">
                    <animate attributeName="stop-color" values="lightblue;blue;red;red;purple;lightblue" dur="8s" repeatCount="indefinite" begin='.7s' />
                  </stop>
                  <stop offset="100%" stop-color="lightblue" stop-opacity=".5">
                    <animate attributeName="stop-color" values="lightblue;orange;purple;purple;blue;lightblue" dur="8s" repeatCount="indefinite" begin='.7s'/>
