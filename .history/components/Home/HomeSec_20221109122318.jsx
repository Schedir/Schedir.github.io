  ...
  return (
    <div>
      <div className='relative bg-schedir-blue z-10 '>
        ...
        <div className='flex h-screen justify-center items-center mx-[10vw] background-animate
         bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell '>
          <motion.img 
          ...
          <motion.svg 
            ...
            width="7293" height="1418" viewBox="0 0 7293 1418" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <mask id="Mask">
                <rect x="0" y="0" width="1000" height="200" fill="url(#Gradient)" />
              </mask>
            </defs>

            <rect x="0" y="0" width="1000" height="200" fill="green" />
            <rect x="0" y="0" width="1000" height="200" fill="red" mask="url(#Mask)" />
          </motion.svg>
        </div>
