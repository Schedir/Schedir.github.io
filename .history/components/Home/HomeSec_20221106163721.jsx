  ...
  return (
    <AnimatePresence>
      <div className='relative'>
        ...
        <div className='fixed flex h-screen w-screen bg-[url("/media/IMG_1367.png")] bg-cover z-0'/>
        <div className='fixed left-[calc(50vw-100px)] top-[20vh] z-10'>
          <motion.h1 
          style={{scale:useTransform(springscroll, [0, .5], [1.5, -3])}} 
