      ...
      <div className='relative bg-schedir-blue z-0 '>
        <div className='flex h-screen justify-center items-center mx-[20vw]'>
          <div className='absolute left-[calc(50vw-150px)] top-[54.2vh] '>
            <img src='/HomeMedia/logoalghe.png' className='absolute top-[-20vh] max-w-[400%] w-[290%] flex justify-center'/>
            <motion.h1 
            // id='stroke'
            style={{scale:useTransform(springscroll, [0, .5], [1.5, 0])}} 
            className='text-center text-transparent text-[25px] sm:text-[40px] md:text-[55px] lg:text-[75px] 
            mt-[5vh] 
            font-extrabold 
