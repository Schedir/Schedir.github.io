              ...
              <defs>
                <linearGradient id="first">
                  <stop offset="0%" stop-color="lightblue" stop-opacity=".5">
                    <animate attributeName="stop-color" values="lightblue;blue;purple;lightblue" dur="8s" repeatCount="infinite" begin='0s' />
                  </stop>
                  <stop offset="100%" stop-color="lightblue" stop-opacity=".5">
                    <animate attributeName="stop-color" values="lightblue;orange;purple;lightblue" dur="8s" repeatCount="infinite" begin='0s'/>
                  </stop>
                </linearGradient>
