        ...
        <div className='flex items-center h-[1000px] bg-schedir-blue'>
            <div ref={ref} className='container flex mx-5'>
                ...
                className='justify-center items-center mx-auto'>
                    <motion.h2 className='bg-clip-text bg-gradient-to-r from-schedir-red via-schedir-yell to-schedir-green text-trasparent text-[3em] text-bold'>Testwo</motion.h2>
