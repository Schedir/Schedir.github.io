    ...
    <>
      <ScrollContainer>
        ...
        <ScrollPage>     
          ...
          <h2 className='leading-none text-xl md:text-[60px] text-gray-300 bold text-center bg-schedir-blue'>
          ...
          {/* <Waves/>  */}
          <div className='bl-10  bg-schedir-blue'>
            <h2 className='text-sm md:text-xl text-gray-400 text-center py-0 '>
        ...
        <ScrollPage>
          ...
          <h2 className='text-sm md:text-xl text-gray-400 text-center'>
            <Animator animation={batch(Fade(0,1), Move(undefined,1000,undefined,-300), Sticky(undefined,40))}>
            {/* <Animator animation={FadeUp}> */}
        ...
        <ScrollPage>
          ...
          {/* <Waves/>  */}
          <h2 className='text-sm md:text-xl text-gray-400 text-center'>
            <Animator animation={batch(Fade(0,1), Move(undefined,600,undefined,-300), Sticky(undefined,65))}>
            {/* <Animator animation={batch(Fade(), Move())}> */}
        ...
        <ScrollPage>
          <h2 className='leading-none text-xl md:text-[70px] text-gray-300 bold text-center'>
            <Animator animation={batch(Fade(), Move(-900, undefined, 1000, undefined), Sticky(undefined,85))}>
            {/* <Animator animation={batch(Fade(), Move())}> */}
            Homeland of foreigners
            </Animator>          
          </h2>     
          <h2 className='text-sm md:text-xl text-gray-400 text-center mb-0'>
            <Animator animation={batch(Fade(0,1), Move(undefined,900,undefined,-300), Sticky(undefined,40))}>
            {/* <Animator animation={batch(Fade(), Move())}> */}
