...
const HomeSec = () => {
  ...
  return (
    <AnimatePresence>
        ...
        <div className='text-center bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell bg-clip text-[15px] sm:text-[15px] md:text-[20px] lg:text-[23px]'>
