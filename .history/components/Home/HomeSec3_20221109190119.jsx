    ...
    <>
      <div className='relative'>
        <div ref={ref} className=" h-[200vh] my-auto mx-auto mt-[-70vh]">
          <div className='sticky top-[35vh] text-left mx-[10%] mt-[30vh] -z-30'>
              <motion.div 
      ...
      <div>
        <motion.img 
        style={{translateX:useTransform(springscroll, [0,.8], [0, 0])}} src='/HomeMedia/IMG_costa_2.png' className='sticky bottom-[-20vh] mt-[-90vh] z-30 -rotate-180'/>
      </div>
    </>
  )
}
