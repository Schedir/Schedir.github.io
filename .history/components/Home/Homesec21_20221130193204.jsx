...
const Homesec21 = () => {    
    ...
    <>
      ...
      <div ref={ref} className='z-20 mt-[0vh] mb-[70vh] '>
            ...
            <div className=' -z-20'>
                <motion.div                  className='mt-[-20vh] overflow-hidden bg-[url("/HomeMedia/IMG_2.png")] object-none object-center '>
                    <div className='container h-[60vh] w-[20vw] bg-clip-padding'>
                      {/* <motion.img 
                        className='rounded-md'
                        viewport={{once:false, amount:0.5, margin:['-150px 0px 0px 0px']}}
                        src='/HomeMedia/IMG_2.png' width="100%"/> */}
                    </div>
