        ...
        <div ref={ref} className='z-20 mt-[30vh] mb-[10vh] '>
              <div className='flex justify-end z-30 mb-[10vh] mr-[7%]'>
                <motion.div  
                  ...
                  style={{opacity:useTransform(scrollYProgress, 
                    ...
                    [0 + '%', 100 + '%',100 + '%', 100 + '%'])}} >
                    <motion.h2 
                    className='text-transparent bg-clip-text text-left background-animate bg-gradient-to-r  text-[25px] sm:text-[40px] md:text-[55px] lg:text-[70px] font-bold '>
              ...
              <div className=' top-[80vh] lg:top-[40vh] mx-20 -z-20'>
                  <motion.div
                    ...
                    lg:h-[70vh] lg:w-[30vw] bg-clip-padding bg-[url("/HomeMedia/IMG_5.png")] bg-center z-[10]'>
                    {/* <motion.img 
