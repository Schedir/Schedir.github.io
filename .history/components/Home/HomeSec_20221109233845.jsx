    ...
    <div>
      ...
      <div className='relative bg-schedir-blue'>
        <div className="h-[200vh] items-center justify-center my-auto mx-auto">
            <div className='sticky top-[35vh] text-right mx-[20%] bg-schedir-blue z-30'>
                  <div className='flex'>
                    <motion.div 
                  ...
                  <motion.img 
                      style={{translateX:useTransform(springscroll, [0,.8], [200, -3600])}} src='/HomeMedia/IMG_costa.png' className='absolute pt-[16vh] ml-[-20vw]'/>
            </div>
