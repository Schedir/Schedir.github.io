...
const HomeSec1 = () => {
  ...
  return (
    <div>
      <div className='relative bg-schedir-blue mb-[-25vh] mt-[-30vh] -z-10'>
        <div className="items-center justify-center my-auto mx-auto">
          ...
          <motion.img 
            style={{translateX:useTransform(springscroll, [0,.8], [10, 0])}} src='/HomeMedia/IMG_costa_2.png' className='sticky bottom-0 mt-[50vh] w-screen'/>
      </div>
