...
const HomeSec = () => {
  ...
  const { scrollYProgressref } = useScroll({
    target: ref,
  ...
  return (
    <div >
      <div className='sticky top-[-44vh] left-[20vw] bg-schedir-blue z-0 '>
        <div ref={ref} className='flex h-screen justify-center items-center mx-[20vw]'  >
          <motion.div  className=' h-screen' 
          style={{
            scale:useTransform(springscrollref, [0, .9], [.8, -9]),
            x:useTransform(springscrollref, [0,.7],[0,-7000])
          }}  
          >
