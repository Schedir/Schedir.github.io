  ...
  return (
    <>
      <div className='relative'>
        <div ref={ref} className=" h-[200vh] my-auto mx-auto mt-[-30vh]">
      ...
      <motion.div style={{scaleX:-1}}>
        <motion.img 
        style={{translateX:useTransform(springscroll, [0,.8], [0, 0])}} src='/HomeMedia/IMG_costa_2.png' className='sticky bottom-[90vh] lg:bottom-[-20vh] mt-[-90vh] z-30'/>
      </motion.div>
    </>
  )
}
