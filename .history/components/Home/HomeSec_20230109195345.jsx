        ...
        <div className="h-[190vh] items-center justify-center my-auto mx-auto">
            <div className='sticky top-[35vh] text-right mx-[10%] mb-[20vh]'>
                  <div className='flex justify-end'>
                    <motion.div 
                      style={{backgroundPositionY:useTransform(springscroll, [0, .9], [-10 + '%', 350 + '%'])}}
                      className='bg-auto bg-center bg-clip-text bg-[url("/HomeMedia/back_sec.png")] text-transparent '>
                          <div className=' text-[25px] sm:text-[40px] md:text-[55px] lg:text-[60px] font-bold z-40 '>
                              An sailing voyage,<br/> to discover Mediterran Sea
                          </div>
                    </motion.div>
                </div>
                  {/* <motion.img 
                      style={{translateX:useTransform(springscroll, [0,.8], [200, -3600])}} src='/HomeMedia/IMG_4.png' className='absolute mt-[28vh] lg:mt-[-17vh] lg:ml-[-20vw] lg:scale-125 scale-90'/> */}
            </div>
            ...
            <div className='sticky top-[60vh] lg:top-[47vh] text-right mx-[10%] z-30'>
              <div className='z-10'>
                <motion.div 
                    ...
                    viewport={{once:false, amount:1, margin:['-320px 350px 0px 0px']}}
