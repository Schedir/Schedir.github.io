...
const HomeSec2 = () => {
  ...
  return (
    <>
        ...
        <div className='z-20 mt-[40vh] mb-[40vh] '>
              <div className='flex justify-end text-right z-30 mb-[10vh] mx-[10%]'>
                <motion.div >
                    <h2 
                    ...
                    Being foreigners</h2>
                    <span className='text-transparent bg-clip-text background-animate bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell text-[15px] sm:text-[15px] md:text-[20px] lg:text-[29px]'>
              ...
              <div className='absolute -z-20'>
                  <motion.div
                    ...
                    <motion.img 
                      ...
                      src='/HomeMedia/IMG_00.png' width="70%"/>
                  </motion.div>
              </div>
          </div>
          {/* <div>
