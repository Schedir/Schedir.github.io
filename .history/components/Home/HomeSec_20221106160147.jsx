...
const HomeSec = () => {
  ...
  return (
    <AnimatePresence>
        ...
        <div className='flex h-screen items-center justify-center bg-[url("/media/IMG_1367.png")] bg-cover z-20'>
            <motion.h1 
        ...
        <div className="h-[200vh] items-center justify-center my-auto mx-auto mt-[-40vh] z-10">
