  ...
  return (
    <>
        ...
        <div ref={ref} className='z-20 mt-[30vh] mb-[10vh] '>
              <div className='flex justify-end z-30 mb-[10vh] mr-[7%]'>
                <motion.div  
                  ...
                  style={{opacity:useTransform(scrollYProgress, 
                    ...
                    Sailing it teaches that we are all children of the same mother Nature, <br/>
                    showing that our multiple cultures are not divergent, but complementary. <br/>
              ...
              <div className=' top-[80vh] lg:top-[40vh] mx-16 -z-20'>
                  <motion.div
                    style={{backgroundPositionX:useTransform(scrollYProgress, 
                      [0, 1],
                      [0 + '%', 100 + '%'])}}
                    className='mt-[-20vh] container h-[30vh] w-[40vw] 
                    lg:h-[70vh] lg:w-[45vw] bg-clip-padding bg-[url("/HomeMedia/IMG_5.png")] bg-cover bg-center z-[10] '>
                    {/* <motion.img 
