...
const Homesec21 = () => {    
    ...
    <>
      <div ref={ref} className='z-20 mt-[-50vh] lg:mt-[90vh] mb-[100vh]'>
        <div className='flex justify-center text-right z-30 mb-[0vh] lg:mr-[-13%]'>
          <motion.div  
      ...
      <div className='mb-[70vh] -z-10'>
        <motion.div
          style={{y}} 
          className='flex justify-start mx-[5vw] lg:mx-[5vw] mt-[-90vh] lg:mt-[-20vh]'>
        ...
        <motion.div
          className='flex justify-end mt-[-90vh] lg:mr-[5vw]'>
            <motion.div 
              style={{y2}} 
              className='container h-[30vh] w-[20vw] lg:h-[70vh] lg:w-[15vw] bg-clip-padding bg-[url("/HomeMedia/IMG_3.png")] bg-bottom bg-cover z-[10]'>
            </motion.div>
        </motion.div>
      </div>
    </>
