  ...
  return (
    <div>
      <div className='relative bg-schedir-blue z-0 '>
        ...
        <div className='absolute top-[54.5vh] -z-20'>
          <div className='container overflow-hidden h-[56vh] object-none object-bottom w-full'>5.5
            <video className='scale-[135%] mt-[-70vh]' autoPlay loop muted >
