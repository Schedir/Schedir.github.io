    ...
    <div>
      <div className='flex justify-center items-center bg-opacity-50'>
        <div className='bg-fixed bg-[url("/media/Schedir_1.JPG")] bg-cover w-screen h-64 z-30 mx-0' >
          <p className='font-bold text-[25px] sm:text-[15px] md:text-[20px] lg:text-[27px] text-transparent mx-[10vw] my-[5%]
      ...
      <div className='relative bg-schedir-blue mb-[-25vh] mt-[-10vh] -z-30'>
        <div className="items-center justify-center my-auto mx-auto">
          ...
          <div className='h-[300vh] my-20vh justify-center'>
            <img src='/HomeMedia/sfondosfumatura5.jpg' className='mt-[0vh] h-[100vh] absolute -z-30 '/> 
            <canvas id="hero-lightpass" className='sticky bottom-[0vh] ml-[50vw] lg:ml-[90.5vh] pt-[50vh] mb-[130vh] lg:mb-[60vh] w-full -z-10'/>
            <img src='/HomeMedia/sfondoblu.png' className='absolute top-0 h-[150vh] lg:top-48 -z-0'/>
          </div>
