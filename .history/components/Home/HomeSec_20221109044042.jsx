  ...
  return (
    <div>
      <div className='relative bg-schedir-blue z-10 '>
        ...
        <div className='flex h-screen justify-center items-center mx-[10vw] bg-schedir-yell'>
          <motion.img 
          ...
          <motion.svg 
            initial={"hidden"}
            whileInView={"visible"}
            className='background-animate bg-clip-content bg-gradient-to-r from-schedir-green via-schedir-red2 to-schedir-yell'
