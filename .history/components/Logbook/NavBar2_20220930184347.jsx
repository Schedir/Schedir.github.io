...
const NavBar2 = () => {
  ...
  return (
    <div id='Navbar' style={{backgroundColor: `${color}`}} className='fixed left-0 top-5 w-screen z-10 ease-in duration-300'>
        <div className='max-w-[1500px] my-auto flex justify-between items-center p-4'>
            ...
            <div className=" flex-row md:w-auto " id="navbar-default">
                <ul className="flex flex-row p-3 mt-auto mr-10 bg-schedir-lavander/10 rounded-lg border-0 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-schedir-lavander/10">
                    ...
                    <li>
                    <a href="/logbook" className="block text-schedir-white hover:text-schedir-yell hover:scale-105 py-1 pr-4 pl-3 text-xs md:text-[16px] md:border-0 md:p-0">Logbook</a>
                    </li>
                    <li>
                    <a href="#" className="block text-schedir-white hover:text-schedir-yell hover:scale-105  py-1 pr-4 pl-3 text-xs md:text-[16px] md:border-0 md:p-0 ">The Route</a>
                    </li>
                    <li>
