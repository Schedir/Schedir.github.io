  ...
  return (
    <div className='grid ml-[50%] justify-items-start'>
        <div className="mb-10 ml-[5em]" ref={ref}>
          <motion.div
            key={"my_unique_key"}
            exit={{ opacity:isInView ? 0:0, transition: { duration: 0.5 } }}
            initial={{ opacity:isInView ? 0:0, transition: { duration: 1 } }}
            animate={{ opacity:isInView ? 1:0, transition: { duration: 0.5 } }}>
