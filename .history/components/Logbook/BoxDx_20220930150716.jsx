...
const BoxDx = ({title, text}) => {
  ...
  const textAnimate={
    ...
    onscreen:{x:"calc(100vw - 50%)", opacity:1}}
      ...
      <div className="mb-10 ml-[5em]">
        ...
        <AnimatePresence>
          <motion.div
            ...
            // exit={{y:isInView ? 1 :"50%", opacity:0, scale:0.5}} 
            >
              
            <motion.a href="#" className="block p-6 max-w-xl bg-[url('/media/prova.jpg')] rounded-lg border shadow-md hover:scale-105 border-gray-700 transition ease-in-out" variants={textAnimate} >
