      ...
      <div className="mb-10 ml-[5em]">
        ...
        <AnimatePresence>
          <motion.div
            ...
            <motion.a href="#" className="block p-6 max-w-xl bg-[url('/media/prova.jpg')] rounded-lg border shadow-md hover:scale-105 border-gray-700 transition ease-in-out" 
            variants={textAnimate}transition= {{ease:"easeIn"}} >
