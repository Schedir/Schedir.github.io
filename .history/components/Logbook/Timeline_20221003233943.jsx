  ...
  return (
    <div className='mt-20'>
      ...
      <div className="container mx-auto w-full h-full">
          ...
          <BoxDx title={'Testo di prova'} text={'testo di prova, testo di prova, testo di prova, testo di prova, testo di prova, testo di prova, testo di prova, testo di prova, '}/>
