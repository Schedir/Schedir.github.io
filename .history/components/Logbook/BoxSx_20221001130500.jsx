        ...
        <div className="mx-3 md:mb-10 md:mr-[5em]">
          <AnimatePresence>
            <motion.div
              ...
              <motion.a className="block p-6 max-w-xl bg-[url('/media/prova.jpg')] rounded-lg border shadow-md hover:scale-105 border-gray-700" type="button" data-modal-toggle="defaultModal" 
