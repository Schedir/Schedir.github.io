        ...
        <div className="mx-3 md:mb-10 md:mr-[5em]">
          <AnimatePresence>
            <motion.div
              ...
              <motion.a className="block p-3 md:p-6 max-w-xl bg-[url('/media/prova.jpg')] rounded-lg border shadow-md hover:scale-105 border-gray-700" type="button" data-modal-toggle="defaultModal" 
               variants={boxAnimate} whileHover={{ scale: 1.1 }}>
                  ...
                  <p className="font-normal text-xs md:text-1xl text-gray-700 dark:text-gray-400">{text}</p>
              </motion.a>
            </motion.div>
          </AnimatePresence>
        </div>
