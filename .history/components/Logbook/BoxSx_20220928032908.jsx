  ...
  return (
    <div className='grid mr-[50%] justify-items-end'>
        <div className="mb-10 mr-[5em]">
            <a href="#" className="block p-6 max-w-xl bg-[url('/media/prova.jpg')] rounded-lg border shadow-md hover:scale-105 border-gray-700 transition ease-in-out" type="button" data-modal-toggle="defaultModal>
