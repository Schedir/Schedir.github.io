...
const DateLineVert = ({Date}) => {
  return (
    <div>
        <h1 className='text-center text-schedir-white mb-4 ml-9'>{Date}</h1>
        <ol className="absolute border-l h-fit border-gray-200 schedir-white items-center justify-items-center justify-between">
