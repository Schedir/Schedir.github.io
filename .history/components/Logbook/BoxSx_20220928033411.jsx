...
const BoxSx = ({title, text}) => {
  return (
    <div className='grid mr-[50%] justify-items-end'>
        ...
        {/* // <!-- Main modal --> */}
        <div id="defaultModal" tabindex="-1" aria-hidden="true" class="hidden  fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                {/* <!-- Modal content --> */}
                <div class="relative bg-schedir-lavander/70 rounded-lg shadow ">
                    {/* <!-- Modal header --> */}
