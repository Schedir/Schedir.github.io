        ...
        <div className="mx-3 md:mb-10 md:mr-[5em]">
          <AnimatePresence>
            <motion.div
              ...
              <motion.a className="block p-3 md:p-6 max-w-xl bg-[url('/media/ " + imgurl + "')] rounded-lg border shadow-md border-gray-700" type="button" data-modal-toggle="defaultModal" 
