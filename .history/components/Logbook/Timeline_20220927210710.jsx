  ...
  return (
    <div className='mt-20'>
      <div className="container mx-auto w-full h-full">
        <ol className="relative border-l border-gray-200 schedir-white ml-[50%]">
          ...
          <li className="mb-10 ml-4">
            <a href="#" className="block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                  <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Vacca boia 2020</h5>
