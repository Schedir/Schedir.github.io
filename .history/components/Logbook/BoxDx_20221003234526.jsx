      ...
      <div className="mx-3 md:mb-10 md:ml-[5em]">
        ...
        <AnimatePresence>
          <motion.div
            ...
            <motion.a href="#" className={"block p-3 md:p-6 max-w-xl bg-[url('/media/box.JPG')] bg-cover bg-center rounded-lg border shadow-md border-gray-700 " + ("bg-[url('/media/" + imgurl + "')]}")}
