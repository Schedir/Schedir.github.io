...
const Main = () => {
  ...
  const FadeUp = batch(Fade(), Move(undefined,900,undefined,undefined), Sticky(undefined,70));
    ...
    <>
      <ScrollContainer>
        ...
        <ScrollPage>     
          ...
          <h2 className='leading-none text-xl md:text-[60px] text-gray-300 bold text-left'>
