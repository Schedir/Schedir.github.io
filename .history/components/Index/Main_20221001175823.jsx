...
const Main = () => {
  ...
  const FadeUp = batch(Fade(), Move(undefined,900,undefined,undefined), Sticky(45,50));
    ...
    <>
      <ScrollContainer>
        ...
        <ScrollPage>     
          ...
          {/* <Waves/>  */}
          <div className='bl-10'>
            <h2 style={{ fontSize: 50 }} className='text-sm md:text-[20px] text-gray-400 text-center py-0 '>
