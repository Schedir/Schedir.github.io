...
const Main = () => {
  ...
  const FadefromLeft = batch(Fade(), Move(1400,700, -2000, undefined), Sticky(undefined,20));
  const FadeUp = batch(Fade(), Move(undefined,900,undefined,undefined), Sticky(undefined,50));
    ...
    <>
      <ScrollContainer>
        ...
        <ScrollPage>     
          ...
          {/* <Waves/>  */}
          <div className='bl-10'>
            <h2 style={{ left: 10 }} className='text-sm md:text-[20px] text-gray-400 text-center py-0 '>
