...
const Main = () => {
  ...
  const FadefromLeft = batch(Fade(), Move(1400,700, -2000, undefined), StickyIn(undefined,30));
  const FadeUp = batch(Fade(0,1), Move(undefined,900,undefined,undefined), StickyIn(undefined,60));
