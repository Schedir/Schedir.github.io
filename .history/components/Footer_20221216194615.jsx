  ...
  return (
      <div className='relative bottom-0 z-[999]'>
        ...
        <footer className="p-4 bg-schedir-blue rounded-lg shadow md:px-16 md:py-8 z-[-11]">
            ...
            <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">P</a>. All Rights Reserved.
            </span>
        </footer>
