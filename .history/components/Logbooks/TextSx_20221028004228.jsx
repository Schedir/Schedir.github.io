    ...
    <div className='flex justify-start ml-[10vw]'>
        ...
        <AnimatePresence>
            <motion.div
              ...
              <motion.a href="#" className="block p-0 mb-8 md:p-5 max-w-[30vw] bg-transparent hover:scale-105" 
              variants={boxAnimate} whileHover={{ scale: 1.07 }}>
                  <h5 className="mb-2 text-[15px] sm:text-[17px] md:text-[23px] xl:text-[25px] text-right tracking-tight text-white ">{props.text}</h5>
