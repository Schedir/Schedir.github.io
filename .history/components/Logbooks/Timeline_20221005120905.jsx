  ...
  return (
    <div className='mt-20'>
      ...
      <div className="container mx-auto w-full h-full">
          ...
          <BoxDx
          title={'Testo di prova'}
          imgurl={"bg-[url('/media/Schedir_2.JPG')]"}
          text={'The Wind is the voice of existence: <br/>it blows fertile on land and sea, carrying its knowledge.<br/> He is an ambassador of Natural Balance, destroyer and creator,<br/> he demolishes and sculpts.<br/> Wind is the first breath of a living being, it is the whisper of its death. <br/>
          ...
          Moving with him is a journey towards our roots, a ret'}/>
