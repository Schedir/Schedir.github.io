        ...
        <AnimatePresence>
          <motion.div
            ...
            whileTap={{ scale: 0.9 }} >
                ...
                <img src={props.imgurl} className=' absolute object-cover md:object-cover '/>
                <h5 className="relative mb-2 text-[15px] sm:text-[17px] md:text-[23px] xl:text-[25px] font-bold tracking-tight text-white">{props.title}</h5>
