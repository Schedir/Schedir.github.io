        ...
        <div 
          ...
          <AnimatePresence>
            <motion.div
              ...
              <motion.a className={"block p-2 mb-8 md:p-5 max-w-[30vw] overflow-clip rounded-lg border shadow-md border-gray-700 min-w-[30vw] md:min-w-[30vw] min-h-[5vh] md:min-h-[15vh]"}
