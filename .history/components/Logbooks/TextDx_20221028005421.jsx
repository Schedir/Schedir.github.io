        ...
        <div className="mx-3 md:mt-10 ">
          <AnimatePresence>
            <motion.div
              ...
              <motion.a href="#" className="block p-0 mb-8 md:p-5 max-w-[30vw] min-w-[30vw] md:min-w-[30vw] min-h-[5vh] md:min-h-[15vh] bg-transparent hover:scale-105 z-30"
              variants={boxAnimate} whileHover={{ scale: 1.07 }}>
                  ...
                  <p className="font-normal text-[10px] sm:text-[12px] md:text-[18px] xl:text-[20px] text-right text-gray-400">{props.auth}</p>
              </motion.a>
