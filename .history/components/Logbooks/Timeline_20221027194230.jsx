...
const Timeline = () => {
  ...
  return (
    <div className=''>
      ...
      <motion.div style={{y}}>
        <div className='flex justify-center max-w-fit mx-auto mt-[-20vh]'>
          <h1 className='text-center text-xs sm:text-base md:text-lg bg-schedir-blue text-schedir-white p-1'>Explore</h1>
        </div>
        <div className={'flex justify-end mr-[50%] z-0'}>
          <div className=" border-r h-[20vh] border-schedir-white"/>
        </div>
      </motion.div>
      {log}
