...
const BoxSx = (props) => {
  ...
  return (
    <div classNameName='flex justify-start ml-[10vw]'>
        <div 
          classNameName="mx-3 md:mt-10 md:mx-10 ">
          <AnimatePresence>
            <motion.div
              initial={"offscreen"}
              ...
              <motion.a classNameName={"block p-2 mb-8 md:p-5 max-w-[30vw] " + (props.imgurl) + " bg-cover bg-center rounded-lg border shadow-md border-gray-700 min-w-[30vw] md:min-w-[30vw] min-h-[5vh] md:min-h-[15vh]"}
               variants={boxAnimate} whileHover={{ scale: 1.07 }} 
               whileTap={{ scale: 0.9 }}>

                  <h5 classNameName="mb-2 text-[15px] sm:text-[17px] md:text-[23px] xl:text-[25px] font-bold tracking-tight text-white">{props.title}</h5>
                  <p classNameName="font-normal text-[10px] sm:text-[12px] md:text-[18px] xl:text-[20px] text-gray-100">{props.text}</p>
