      ...
      <div className="mx-3 md:mt-10 md:mx-10">
        ...
        <AnimatePresence>
          <motion.div
            ...
            <motion.a className={"flex p-2 mb-8 md:p-0 max-w-[30vw] rounded-lg border overflow-hidden shadow-md border-gray-700 min-w-[30vw] md:min-w-[30vw] min-h-[5vh] md:min-h-[15vh]"}
