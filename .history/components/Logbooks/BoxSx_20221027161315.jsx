...
const BoxSx = (props) => {
  ...
  return (
    <div className='flex justify-start '>
        <div className="mx-3 md:my-5 md:mx-10">
          <AnimatePresence>
            <motion.div
              initial={"offscreen"}
              ...
              <motion.a className={"block p-3 md:p-6 max-w-xl " + (props.imgurl) + " bg-cover bg-center rounded-lg border shadow-md border-gray-700 md:min-w-[30vw] md:min-h-[10vh]"}
