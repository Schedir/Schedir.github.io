  ...
  const log = logdata.map((logdata) => {
    return(
          <div key={logdata.id}>
            ...
            <div className='absolute mt-[3vh] mx-[10vw] z-10'>
                { logdata.content.map((content) => (

                    <motion.div key={content.id} style={{y}} className='w-[90vw]'>
                        if({content.type} == "BoxSx"){
                          <BoxSx 
              ...
              <DateLine 
                ...
                box={
                  logdata.content.map((content) => (
                    <motion.div key={content.id} style={{opacity:1}}>
                      <BoxSx
                        title={content.title}
                        imgurl={"bg-[url('/media/box-2.jpg')]"}
                        text={content.text} />
