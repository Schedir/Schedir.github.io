...
const BoxSx = props => {
  ...
  return (
    <div className='flex justify-start ml-[4vw]'>
        <div 
          ...
          <AnimatePresence>
            <motion.div
              ...
              <motion.a className={`block p-0 overflow-hidden mb-8 rounded-xl border shadow-md border-gray-700 min-w-[30vw] md:min-w-[30vw] max-w-[30vw] min-h-[5vh] md:min-h-[35vh]`}
