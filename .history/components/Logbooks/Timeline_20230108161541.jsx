  ...
  const log = logdata.map((logdata) => {
    return(
          <div key={logdata.id}>
            ...
            <div className='absolute w-full mt-10 z-50' style={{y}}>
  ...
  return (
    <div>
      ...
      <div className='relative overflow-hidden w-full h-screen flex items-center justify-center z-[2]'>
            ...
            className='text-transparent text-[40px] md:text-[90px] font-bold
            bg-clip-text background-animate
            bg-gradient-to-r from-schedir-violet via-schedir-gneon to-schedir-g1
            hover:from-schedir-g1 hover:to-schedir-violet hover:via-schedir-gneon'>
              Logbook
            </motion.h1>
      </div>
      <motion.div style={{y}}>
        <div className='flex justify-center animate-bounce max-w-fit mx-auto mt-[-30vh]'>
          <motion.h1 className='text-center text-xs sm:text-base  md:text-lg bg-schedir-blue text-schedir-white p-1'>Explore</motion.h1>
        </div>
