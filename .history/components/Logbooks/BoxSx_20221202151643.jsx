...
const BoxSx = (props) => {
  ...
  return (
    <div className='flex justify-start ml-[10vw]'>
        ...
        <div id="staticModal" data-modal-backdrop="dynamic" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 p-4 w-full md:inset-0 h-modal md:h-full">
