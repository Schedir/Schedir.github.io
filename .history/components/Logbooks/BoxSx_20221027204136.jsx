        ...
        <div className="mx-3 md:mt-10 md:mx-10 ">
          <AnimatePresence>
            <motion.div
              ...
              <motion.a className={"block p-3 md:p-6 max-w-[30vw] " + (props.imgurl) + " bg-cover bg-center rounded-lg border shadow-md border-gray-700 md:min-w-[30vw] md:min-h-[15vh]"}
