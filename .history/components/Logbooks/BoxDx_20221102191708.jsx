      ...
      <div className="mx-3 md:mt-10 md:mx-10">
        ...
        <AnimatePresence>
          <motion.div
            ...
            <motion.a className={"static p-2 mb-8 md:p-5 max-w-[30vw] rounded-lg border overflow-hidden shadow-md border-gray-700 min-w-[30vw] md:min-w-[30vw] min-h-[5vh] md:min-h-[15vh]"}
            ...
            whileTap={{ scale: 0.9 }} >
                ...
                <img src={props.imgurl} className='static object-fill md:object-contain '/>
