        ...
        <div 
          ...
          <AnimatePresence>
            <motion.div
              ...
              <motion.a className={`static block p-0 overflow-hidden mb-8 max-w-[30vw] rounded-xl border shadow-md border-gray-700 min-w-[30vw] md:min-w-[30vw] min-h-[5vh] md:min-h-[15vh]`}
                variants={boxAnimate} whileHover={{ scale: 1.07 }} 
                whileTap={{ scale: 0.9 }}>

                <img src={"/LogMedia/"+ (props.imgurl)} alt="" className='absolute object-fill'/> 

                  <h5 className="static p-2 text-[15px] sm:text-[17px] md:text-[23px] xl:text-[25px] font-bold tracking-tight text-white">{props.title}</h5>
